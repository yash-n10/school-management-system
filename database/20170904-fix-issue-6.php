...
$schema_patch_name = '20170904-fix-issue-6';

$one_off_queries = array();

$per_school_queries = array("
ALTER TABLE `class_teachet_alloc` 
CHANGE COLUMN `id` `id` INT(11) NOT NULL AUTO_INCREMENT ,
CHANGE COLUMN `class_id` `class_id` INT(11) NOT NULL ,
CHANGE COLUMN `section_id` `section_id` INT(11) NOT NULL ,
CHANGE COLUMN `teacher_id` `teacher_id` INT(11) NOT NULL ;",
);
