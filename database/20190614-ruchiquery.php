...
//$schema_patch_name = '20190614-ruchiquery10';
...
//    "SET SESSION sql_mode = 'NO_ENGINE_SUBSTITUTION'; ",
        "alter table fee_transaction_head change date_created date_created timestamp null default null;",
        "update  fee_transaction_head set date_created= NULL where date_created='0000-00-00 00:00:00';",
        "alter table fee_transaction_head add column cheque_no varchar(50) after mode,add column cheque_date varchar(100) after cheque_no,add column cheque_status varchar(20) after cheque_date;"
