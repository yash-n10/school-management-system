...
$schema_patch_name = '20190603-nehafee';
...
$per_school_queries = array(
    "ALTER TABLE student add student_type varchar(30) DEFAULT 'EXISTING', add start_fee_month varchar(2) DEFAULT '1';",
    "ALTER TABLE student_class_acedemic_log add student_type varchar(30) DEFAULT 'EXISTING', add start_fee_month varchar(2) DEFAULT '1';",
