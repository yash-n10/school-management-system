...
$schema_patch_name = '20171118-rakeshclassroutine';
...
"ALTER TABLE class_routine ADD period_id int NOT NULL;",
"ALTER TABLE class_routine DROP COLUMN `time_start_min`",
"ALTER TABLE class_routine DROP COLUMN `time_end`",
"ALTER TABLE class_routine DROP COLUMN `time_end_min`",
);
