...
$schema_patch_name = '20171129-nehasalry';
...
"ALTER TABLE leave_type ADD COLUMN loss_of_pay varchar(5) AFTER half_days_allow;",
"ALTER TABLE employee ADD COLUMN academic_year_id int(11) AFTER status;",
"ALTER TABLE employee_category ADD COLUMN academic_year_id int(11) AFTER status;",
"ALTER TABLE employee_department ADD COLUMN academic_year_id int(11) AFTER status;",
"ALTER TABLE employee_leave CHANGE year academic_year_id int(11);",
"ALTER TABLE leave_apply_approve ADD COLUMN academic_year_id int(11) AFTER status;",
"ALTER TABLE leave_entitlement ADD COLUMN academic_year_id int(11);",
"ALTER TABLE leave_group ADD COLUMN academic_year_id int(11) AFTER status;",    
"ALTER TABLE leave_type ADD COLUMN academic_year_id int(11) AFTER status;",    
"ALTER TABLE salary_calculation ADD COLUMN academic_year_id int(11) AFTER status;",    
"ALTER TABLE salary_head ADD COLUMN academic_year_id int(11) AFTER date_created;",    
"ALTER TABLE salary_structure ADD COLUMN academic_year_id int(11) AFTER status;",    
"ALTER TABLE salary_type ADD COLUMN academic_year_id int(11) AFTER status;",    
