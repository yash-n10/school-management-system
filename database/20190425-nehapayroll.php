...
$schema_patch_name = '20190425-nehapayroll';
...
$per_school_queries = array(
    "ALTER TABLE user CHANGE email email varchar(50) DEFAULT NULL;",
    "ALTER TABLE salary_head CHANGE active_status active_status varchar(6) DEFAULT NULL",
