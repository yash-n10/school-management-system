...
//$schema_patch_name = '20180106-neha';
$schema_patch_name = '20180106-nehaa';
$schema_patch_name = '20180106-nehaaa';
...
//    
//"ALTER TABLE student DROP COLUMN parent_email, DROP COLUMN parent_password, DROP COLUMN academic_year, DROP COLUMN passport_number"
//    . ", DROP COLUMN date_of_issue, DROP COLUMN date_of_expiry, DROP COLUMN student_cid, DROP COLUMN father_cid, DROP COLUMN mother_cid ;",
//"ALTER TABLE student CHANGE parent_phone1 father_phone varchar(10), CHANGE parent_phone2 mother_phone varchar(10), CHANGE occupation father_job varchar(255)"
//    . ", CHANGE student_qatar_id student_aadhar varchar(50), CHANGE father_qatar_id father_aadhar varchar(50)"
//    . ", CHANGE mother_qatar_id mother_aadhar varchar(50);" ,
//"ALTER TABLE student ADD mother_tongue varchar(20), ADD mother_job varchar(255), ADD guardian_name varchar(255), ADD guardian_phone varchar(10)"
//    . ", ADD guardian_job varchar(255), ADD guardian_aadhar varchar(50),ADD vision varchar(10);"
//    
//
//);
...
"ALTER TABLE student CHANGE doj admission_date date;"    
