...
$schema_patch_name = '20171204-rakeshacademic';
...
"CREATE TABLE `assignment_category` (
 ...
 `status` varchar(25) NOT NULL DEFAULT 'Y',
...
"CREATE TABLE `assignment` (
 `id` int(11) NOT NULL AUTO_INCREMENT,
 `assi_category_id` int(11) NOT NULL,
...
"CREATE TABLE `assignment_report` (
 ...
 `assignment_status` varchar(255) NOT NULL DEFAULT 'N',
 `date_created` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
 `created_by` int(11) NOT NULL,
 `last_date_modified` datetime NOT NULL,
 `last_modified_by` int(11) NOT NULL,
