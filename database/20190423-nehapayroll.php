...
$schema_patch_name = '20190423-nehapayroll';
...
$per_school_queries = array(
    ...
    "alter table employee_designation add column level int(11) after designation_desc;",
    "ALTER TABLE employee ADD salary_group_id int (11) after employee_code;",  
    "alter table student add column student_ledger_id int(11);",
    "alter table employee add column emp_ledger_id int (11);",
    "ALTER TABLE salary_head ADD salary_group_id int (11) after emp_id;",
    "ALTER TABLE salary_head ADD active_status  varchar (2) after status;",
