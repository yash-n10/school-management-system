...
$schema_patch_name = '20190218-nehaacademics3';

$one_off_queries = array(
);

//$per_school_queries = array(
//	"alter table class_teachet_alloc add column `date_created` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
//            add column `created_by` int(11) NOT NULL,
//            add column `date_modified` datetime NOT NULL,
//            add column `modified_by` int(11) NOT NULL,
//            add index class_id_indx (class_id),
//            add index section_id_indx (section_id),
//            add index teacher_id_indx (teacher_id)",
//        "alter table subject add column `date_created` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
//            add column `created_by` int(11) NOT NULL,
//            add column `date_modified` datetime NOT NULL,
//            add column `modified_by` int(11) NOT NULL",
//        "alter table class_subject_teacher add column `date_created` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
//            add column `created_by` int(11) NOT NULL,
//            add column `date_modified` datetime NOT NULL,
//            add column `modified_by` int(11) NOT NULL,
//            add index class_id_indx (class_id),
//            add index section_id_indx (section_id),
//            add index subject_id_indx (subject_id),
//            add index teacher_id_indx (teacher_id)", 
//        "alter table exam add column `date_created` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
//            add column `created_by` int(11) NOT NULL,
//            add column `date_modified` datetime NOT NULL,
//            add column `modified_by` int(11) NOT NULL"    
//       
