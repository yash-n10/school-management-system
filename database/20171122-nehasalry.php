...
$schema_patch_name = '20171122-nehasalry';
...
"ALTER TABLE salary_head CHANGE COLUMN ctc_year net_payable varchar(20) AFTER ctc_month;",
"ALTER TABLE salary_structure ADD column sal_contri varchar(10) AFTER salary_id;",
"ALTER TABLE salary_calculation ADD column sal_head_id int(20) AFTER month;",
