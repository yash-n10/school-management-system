...
$schema_patch_name = '20171129-rakeshacademic';
...
"ALTER TABLE accedemic_session  ADD COLUMN start_date date AFTER created_by;",
"ALTER TABLE accedemic_session  ADD COLUMN end_date date AFTER start_date;",
"ALTER TABLE class_teachet_alloc ADD COLUMN academic_year_id int(11);",
"ALTER TABLE subject ADD COLUMN academic_year_id int(11);",
"ALTER TABLE class_periods ADD COLUMN academic_year_id int(11);",
"ALTER TABLE class_subject_teacher ADD COLUMN academic_year_id int(11);",
"ALTER TABLE class_substitute_routine ADD COLUMN academic_year_id int(11) AFTER status;",
"ALTER TABLE class_routine ADD COLUMN academic_year_id int(11);",
"ALTER TABLE exam ADD COLUMN academic_year_id int(11);",    
"ALTER TABLE grade ADD COLUMN academic_year_id int(11);",      
"ALTER TABLE class ADD COLUMN academic_year_id int(11);",    
"ALTER TABLE section ADD COLUMN academic_year_id int(11);",    
