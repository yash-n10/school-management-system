...
$schema_patch_name = '20171121-nehasalrycalc';
...
"ALTER TABLE salary_calculation add column working_days varchar(3) default 0;",
"ALTER TABLE salary_calculation add column total_holiday varchar(3) default 0;",
"ALTER TABLE salary_calculation add column total_leave_approved varchar(3) default 0;",
"ALTER TABLE salary_calculation add column absent_days varchar(3) default 0;",
"ALTER TABLE salary_calculation add column paid_days varchar(3) default 0;",
);
