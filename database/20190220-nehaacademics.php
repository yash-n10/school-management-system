...
$per_school_queries = array(
	"alter table exam_routine_head add column status varchar(1) default 1 after exam_id"   ,
        "alter table exam_routine_det add column status varchar(1) default 1 after end_timing, add column date_created timestamp default current_timestamp"
