<?php  
include($_SERVER['DOCUMENT_ROOT']."/assets/gateway/ResMsgDTO.php");
include($_SERVER['DOCUMENT_ROOT']."/assets/gateway/VtransactSecurity.php");
include($_SERVER['DOCUMENT_ROOT']."/assets/gateway/HTTPPost.php");
include($_SERVER['DOCUMENT_ROOT']."/assets/gateway/ReqMsgDTO.php");
