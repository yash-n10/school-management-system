                    ...
                    <tbody>
                        ...
                        <tr>
							...
							<td align="center">
                            	...
                            	<a data-toggle="modal" href="#modal-delete" onclick="modal_delete('<?php echo base_url();?>admin/book/delete/<?php echo $row['book_id'];?>')"
...
$('#book_no').on('change',function(){
	...
	$.ajax({
							type: 'POST',
							url: '<?php echo base_url(); ?>admin/getbookinfo',
							data: { bkid:bookid },
...
$('#issue_user_type').on('change',function(){
	...
	$.ajax({
							type: 'POST',
							url: '<?php echo base_url(); ?>admin/getuserinfo',
							data: { utype:usertype },
							success: function(data) {
								//alert(data);
