	...
	<div class="box-content padded">
    	...
    	<div class="row-fluid">
        		...
        		<div class="span12">
                	    ...
                	    <form class="form-horizontal validatable" method="post" action="<?php echo base_url(); ?>office/fee_period_insert">
            	    ...
            	    <table cellpadding="0" cellspacing="0" border="0" class="dTable responsive">
                            ...
                            <?php if(!empty($feeperiods)) { foreach($feeperiods as $feeperiods_view) { ?>
                            	<tr>
                                    ...
                                    <td><a href="<?php echo base_url();?>office/fee_period_edit/<?php echo $feeperiods_view->fee_period_id ?>" class="btn btn-small btn-lightblue"><i class="icon-edit"></i> Edit</a>  <a data-toggle="modal" href="#modal-delete" onclick="modal_delete('<?php echo base_url();?>office/fee_period_delete/<?php echo $feeperiods_view->fee_period_id ?>')" class="btn btn-small btn-red"><i class="icon-trash"></i> Trash</a></td>
                                </tr>
                            <?php } } ?>    
                            </tbody>
                    </table>
