	...
	<div class="box-content">
		<div class="tab-content">
            ...
            <div class="tab-pane  active" id="list">
				<center>
                	<br />
                	<select name="class_id" onchange="window.location='<?php echo base_url();?>admin/parent/'+this.value">
                                ...
                                <tr>
                                    ...
                                    <td align="center" class="span5">
                                        ...
                                        <a  data-toggle="modal" href="#modal-delete" 
                                        	onclick="modal_delete('<?php echo base_url();?>admin/parent/delete/<?php echo $parent_info->parent_id;?>/<?php echo $class_id;?>')" 
