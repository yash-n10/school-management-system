                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td align="center">
                            	...
                            	<a data-toggle="modal" href="#modal-delete" onclick="modal_delete('<?php echo base_url();?>admin/fees_cat/delete/<?php echo $row['fees_category_id'];?>')" class="btn btn-red btn-small">
