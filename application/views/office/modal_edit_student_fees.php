    ...
    <div class="box-content">
        ...
        <?php echo form_open('admin/class_wise_fees/do_update/'.$row['fee_amount_id'] , array('class' => 'form-horizontal validatable','target'=>'_top'));?>
            ...
            <input type="hidden" id="hiddenBaseUrl" value="<?php echo base_url(); ?>admin/save_student_fees" />
        </form>
	...
	function saveFeesModule(feetype,feecatid,class_id,student_id){
		var amount=$("#feeamnt_"+feecatid).val();
			...
			function(data){
				...
				//window.location='<?php echo base_url(); ?>admin/manage_student_fees/'+student_id;
			});
	}
</script>
