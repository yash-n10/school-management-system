                    ...
                    <tbody>
                        ...
                        <tr>
							...
							<td align="center">
                            	...
                            	<a data-toggle="modal" href="#modal-delete" onclick="modal_delete('<?php echo base_url();?>admin/classes/delete/<?php echo $row['class_id'];?>')" class="btn btn-red btn-small">
...
<script>
  $('#class_name').on('change',function(){
		...
		$.ajax({
							type: 'POST',
							url: '<?php echo base_url(); ?>admin/dryname_chk_class/',
