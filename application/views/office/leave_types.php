	...
	<div class="box-content padded">
    	...
    	<div class="row-fluid">
        		...
        		<div class="span12">
                	    ...
                	    <form class="form-horizontal validatable" method="post" action="<?php echo base_url(); ?>admin/ltypeinsert">
                        <div class="row-fluid">
                        <div class="span6">
            	    ...
            	    <table class="table table-bordered">
                            ...
                            <?php if(!empty($ltype_data)) { foreach($ltype_data as $ltype_data_view) { ?>
                            	<tr>
                                    ...
                                    <td><a href="<?php echo base_url();?>admin/ltypeedit/<?php echo $ltype_data_view->leave_type_id ?>">Edit</a></td>
                                    <td><a data-toggle="modal" href="#modal-delete" onclick="modal_delete('<?php echo base_url();?>admin/ltypedelete/<?php echo $ltype_data_view->leave_type_id ?>')">Delete</a></td>
                                </tr>
                            <?php } } ?>    
                            </tbody>
                    </table>
