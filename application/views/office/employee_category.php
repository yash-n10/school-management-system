                    ...
                    <tbody>
                        ...
                        <tr>
							...
							<td align="center">
                            	...
                            	<a data-toggle="modal" href="#modal-delete" onclick="modal_delete('<?php echo base_url();?>admin/employee_category/delete/<?php echo $employee_categories_list['employee_category_id'];?>')" class="btn btn-red btn-small">
