                    ...
                    <tbody>
                        ...
                        <tr>
							...
							<td align="center">
                            	...
                            	<a data-toggle="modal" href="#modal-delete" onclick="modal_delete('<?php echo base_url();?>office/classnoticeboard/delete/<?php echo $row['notice_id'];?>')" class="btn btn-red btn-small">
