...
<script type="text/javascript">
 ...
 function getAttendenceView(){
	 ...
	 document.daily_attendence_frm.action = "<?php echo base_url() ?>admin/daily_staffattendence_reason";
...
$('.da_mod_cls').on('click',function(){
	...
	var adtype = $(this).data('ad-type');
	 ...
	 $.ajax({
							type: 'POST',
							url: '<?php echo base_url(); ?>admin/staffdaily_attn_update',
...
$('#custom-tam-ssmsa').on('click',function(e){
	...
	else
	{
		...
		$.ajax({
							type: 'POST',
							url: '<?php echo base_url(); ?>admin/daily_attn_count',
...
$(document).on('click','#sms-tam-absenties',function(){
	...
	$.ajax({
							type: 'POST',
							url: '<?php echo base_url(); ?>admin/sendsmsabsenties',
							data: { smscid:smsclassid ,smsdt:smsdate },
							success: function(data) {
