                    ...
                    <tbody>
                        ...
                        <tr>
							...
							<td align="center">
                            	...
                            	<a data-toggle="modal" href="#modal-delete" onclick="modal_delete('<?php echo base_url();?>admin/departments/delete/<?php echo $departments_list['department_id'];?>')" class="btn btn-red btn-small">
