                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td align="center">
                            	...
                            	<a data-toggle="modal" href="#modal-delete" onclick="modal_delete('<?php echo base_url();?>admin/class_wise_fees/delete/<?php echo $row['fee_amount_id'];?>')" class="btn btn-red btn-small">
