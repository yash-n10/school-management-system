                ...
                <div class="tab-pane <?php if(!isset($upload)) { echo 'active' ;}  ?>" id="list">
                    ...
                    <center class="custom-tam-cng-sel-block">
                       ...
                       <span> Change Class </span>
                        ...
                        <select name="class_id" onchange="window.location='<?php echo base_url(); ?>office/student/'+this.value">
    ...
    ?>
        ...
        foreach ($students as $row): ?>
                                                ...
                                                <tr>
                                                       ...
                                                       <div class="custom-tam-table-btns">
                                                            <!--<a data-toggle="modal" href="javascript:;" class="btn btn-lightblue btn-small custom-tam-indsudsms" data-studentid="<?php echo $row['student_id']; ?>" data-stype="sms"><i class="icon-mobile-phone"></i> SMS </a>-->
                                                                    ...
                                                                    <div class="custom-tam-table-btns">
                                                                        ...
                                                                        <a  data-toggle="modal" href="#modal-delete" onclick="modal_delete('<?php echo base_url(); ?>office/student/<?php echo $class_id; ?>/delete/<?php echo $row['student_id']; ?>')" class="btn btn-red btn-small">
                                                    ...
                                                    <!--<a href="<?php echo base_url(); ?>office/student/<?php echo $class_id; ?>/personal_profile/<?php echo $row['student_id']; ?>"
                                                    ...
                                                    <a href="<?php echo base_url(); ?>office/student/<?php echo $class_id; ?>/academic_result/<?php echo $row['student_id']; ?>"
                                                    ...
                                                    <a href="<?php echo base_url(); ?>office/student/<?php echo $class_id; ?>/edit/<?php echo $row['student_id']; ?>"
                                                    ...
                                                    <a href="<?php echo base_url(); ?>office/student/<?php echo $class_id; ?>/delete/<?php echo $row['student_id']; ?>" onclick="return confirm('delete?')"
...
<script>
	...
	$('#student_roll_val').on('change',function(){
		...
		$.ajax({
							type: 'POST',
							url: '<?php echo base_url(); ?>office/sdtrollcheck/',
	...
	/*$('#admission_number').on('change',function(){
		...
		$.ajax({
							type: 'POST',
							url: '<?php //echo base_url(); ?>office/sdtamcheck/',
	...
	$('#student_email_val').on('change',function(){
		...
		$.ajax({
							type: 'POST',
							url: '<?php echo base_url(); ?>office/sdtemailcheck/',
							data: { chkmail:semail },
							success: function(data) {
								//alert(data);
...
$('.custom-tam-indsudsms').on('click',function(e){
	...
	$.ajax({
			type: 'POST',
			url: '<?php echo base_url(); ?>office/sms_student_data',
			data: { sid:stndid },
			success: function(data) {
	...
	$.ajax({
			type: 'POST',
			url: '<?php echo base_url(); ?>office/email_student_data',
			data: { sid:stndid },
			success: function(data) {
...
$(document).on('click','#sndsmsbtn',function(e){
	...
	$.ajax({
			type: 'POST',
			url: '<?php echo base_url(); ?>office/sms_student_snd',
...
$(document).on('click','#sndmailbtn',function(e){
	...
	$.ajax({
			type: 'POST',
			url: '<?php echo base_url(); ?>office/mail_student_snd',
			data:$( '#snd-frm' ).serialize(),
			success: function(data) {
			//alert(data)
				if(data == 'true'){
