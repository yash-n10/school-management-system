                    ...
                    <tbody>
                        ...
                        <tr>
							...
							<td align="center">
                            	...
                            	<a data-toggle="modal" href="#modal-delete" onclick="modal_delete('<?php echo base_url();?>principal/sms_template_view/delete/<?php echo $row['sms_template_id'];?>')" class="btn btn-red btn-small">
