...
$('#route_id').on('change',function(){
	...
	if(rid!=''){
		...
		$.ajax({
							type: 'POST',
							url: '<?php echo base_url(); ?>principal/getpoints/',
							data: { route_id:rid },
 ...
 $('#class_id').on('change',function(){
	...
	$.ajax({
							type: 'POST',
							url: '<?php echo base_url(); ?>principal/ppnt_stn_data/',
  ...
  $('#rdata_id').on('change',function(){
	  ...
	  $.ajax({
							type: 'POST',
							url: '<?php echo base_url(); ?>principal/get_route_data/',
							data: { route_id:rdid },
							success: function(data) {
