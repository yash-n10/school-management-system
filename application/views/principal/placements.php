	...
	<div class="box-content padded">
    	...
    	<div class="row-fluid">
        		...
        		<div class="span12">
                	    ...
                	    <form class="form-horizontal validatable" method="post" action="<?php echo base_url(); ?>principal/placementinsert">
                        <div class="row-fluid">
                        <div class="span6">
            	    ...
            	    <table class="table table-bordered">
                            ...
                            <?php if(!empty($placement_data)) { foreach($placement_data as $placement_data_view) { ?>
                            	<tr>
                                    ...
                                    <td><a href="<?php echo base_url();?>principal/placementedit/<?php echo $placement_data_view->placement_id ?>">Edit</a></td>
                                    <td><a data-toggle="modal" href="#modal-delete" onclick="modal_delete('<?php echo base_url();?>principal/placementdelete/<?php echo $placement_data_view->placement_id ?>')">Delete</a></td>
                                </tr>
                            <?php } } ?>    
                            </tbody>
                    </table>
