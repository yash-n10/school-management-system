                ...
                <table cellpadding="0" cellspacing="0" border="0" class="dTable responsive box">
                    ...
                    <tbody>
                        ...
                        <tr>
							...
							<td align="center">
                            	<a data-toggle="modal" href="<?php echo base_url();?>principal/onlinetestedit/<?php echo $row['onlinetest_id'];?>" <?php /*?>onclick="modal('edit_book',<?php echo $row['ebooks_id'];?>)"<?php */?> class="btn btn-gray btn-small">
                                		<i class="icon-wrench"></i> <?php echo get_phrase('edit');?>
                                </a>
                            	<a data-toggle="modal" href="<?php echo base_url();?>principal/onlinetest/delete/<?php echo $row['onlinetest_id'];?>" onclick="return confirm('Do You wanto delete')"
                                	 class="btn btn-red btn-small">
                                		<i class="icon-trash"></i> <?php echo get_phrase('delete');?>
                                </a>
                               <?php /*?> <a data-toggle="modal" href="#modal-delete" onclick="modal_delete('<?php echo base_url();?>principal/onlinetest/delete/<?php echo $row['onlinetest_id'];?>')" class="btn btn-red btn-small">
                                		<i class="icon-trash"></i> <?php echo get_phrase('delete');?>
                                </a><?php */?>
        					</td>
                        </tr>
