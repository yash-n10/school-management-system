<div class="tab-pane box active" id="edit" style="padding: 5px">
    <div class="box-content">
        ...
        <?php echo form_open('principal/book/do_update/'.$row['book_id'] , array('class' => 'form-horizontal validatable','target'=>'_top'));?>
            <div class="padded">
                ...
                <div class="control-group">
                                ...
                                <div class="controls">
                                    <select name="books_category_id" class="uniform" style="width:100%;">
                                    	<?php 
										$classes3 = $this->db->get('books_category')->result_array();
										foreach($classes3 as $row3):
										?>
                                    		<option value="<?php echo $row3['books_category_id'];?>" <?php if($row3['books_category_id'] == $row['books_category_id']) echo "selected"; ?>><?php echo $row3['books_category_name'];?></option>
                                        <?php
										endforeach;
										?>
                                    </select>
                ...
                <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" class="" name="no_of_copies" value="<?php echo $row['no_of_copies'];?>"/>
                                </div></div>
            </div>
