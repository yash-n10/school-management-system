                    ...
                    <tbody>
                        ...
                        <tr>
							...
							<td align="center">
                            	...
                            	<!--<a data-toggle="modal" href="#modal-delete" onclick="modal_delete('<?php echo base_url();?>principal/leavemanagement/delete/<?php echo $row['leave_id'];?>')" class="btn btn-red btn-small">
...
$('#leave_type').on('change',function(){
	...
	if(ltype !=''){
		 $.ajax({
							type: 'POST',
							url: '<?php echo base_url() ?>principal/ltypedata/',
							data: { lType:ltype  },
		 ...
		 $.ajax({
							...
							success: function(data) {
								...
								if(data=='false'){
								 ...
								 $.ajax({
												type: 'POST',
												url: '<?php echo base_url() ?>principal/caldays/',
												data: { startDate:srtDt ,endDate:enDt },
												success: function(data) {
