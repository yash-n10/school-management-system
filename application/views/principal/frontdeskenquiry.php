		...
		<div class="tab-content">
            ...
            <div class="tab-pane  active" id="list">
                    ...
                    <div class="box">
                      ...
                      <form method="post" action="<?php echo base_url();?>principal/frontdeskenquiry/" class="form-horizontal validatable" enctype="multipart/form-data" name="getfrm">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <!--<td align="center">
                                            ...
                                            <a data-toggle="modal" href="#modal-delete" onclick="modal_delete('<?php //echo base_url();?>principal/staff/delete/<?php //echo $row['staff_id'];?>')"
			...
			<div class="tab-pane box" id="add" style="padding: 5px">
                <div class="box-content">
                	 <form method="post" action="<?php echo base_url();?>principal/frontdeskenquiry/create/" class="form-horizontal validatable" enctype="multipart/form-data">
