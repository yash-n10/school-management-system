	...
	<div class="box-content padded">
    	...
    	<div class="row-fluid">
        		...
        		<div class="span12">
                	    ...
                	    <form class="form-horizontal validatable" method="post" action="<?php echo base_url(); ?>principal/fee_cat_insert">
                        <div class="row-fluid">
                        <div class="span6">
            	    ...
            	    <table class="table table-bordered">
                            ...
                            <?php if(!empty($fee_cat_data)) { foreach($fee_cat_data as $fee_cat_data_view) { ?>
                            	<tr>
                                    ...
                                    <td>
                                    <a href="<?php echo base_url();?>principal/feeparticulars/<?php echo $fee_cat_data_view->fee_category_id ?>" class="btn btn-small btn-green"><i class="icon-edit"></i> Add Particulars</a> 
                                    <a href="<?php echo base_url();?>principal/fee_cat_edit/<?php echo $fee_cat_data_view->fee_category_id ?>" class="btn btn-small btn-lightblue"><i class="icon-edit"></i> Edit</a>  <a data-toggle="modal" href="#modal-delete" onclick="modal_delete('<?php echo base_url();?>principal/fee_cat_delete/<?php echo $fee_cat_data_view->fee_category_id ?>')" class="btn btn-small btn-red"><i class="icon-trash"></i> Trash</a></td>
                                </tr>
                            <?php } } ?>    
                            </tbody>
                    </table>
