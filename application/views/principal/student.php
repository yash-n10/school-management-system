...
$('.custom-tam-indsudsms').on('click',function(e){
	...
	$.ajax({
			type: 'POST',
			url: '<?php echo base_url(); ?>principal/sms_student_data',
			data: { sid:stndid },
			success: function(data) {
	...
	$.ajax({
			type: 'POST',
			url: '<?php echo base_url(); ?>principal/email_student_data',
			data: { sid:stndid },
			success: function(data) {
...
$(document).on('click','#sndsmsbtn',function(e){
	...
	$.ajax({
			type: 'POST',
			url: '<?php echo base_url(); ?>principal/sms_student_snd',
...
$(document).on('click','#sndmailbtn',function(e){
	...
	$.ajax({
			type: 'POST',
			url: '<?php echo base_url(); ?>principal/mail_student_snd',
			data:$( '#snd-frm' ).serialize(),
			success: function(data) {
			//alert(data)
				if(data == 'true'){
