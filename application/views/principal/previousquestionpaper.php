                    ...
                    <tbody>
                        ...
                        <tr>
                           ...
                           <?php //echo $this->crud_model->get_image_url('previousquestionpapers', $row['books_file']); ?> <div class="avatar"></div></a></td>
							...
							<td align="center">
                            	<a data-toggle="modal" href="<?php echo base_url();?>principal/editpaper/<?php echo $row['paperid'];?>" <?php /*?>onclick="modal('edit_book',<?php echo $row['ebooks_id'];?>)"<?php */?> class="btn btn-gray btn-small">
                                		<i class="icon-wrench"></i> <?php echo get_phrase('edit');?>
                                </a>
                            	<a data-toggle="modal" href="<?php echo base_url();?>principal/previousquestionpapers/delete/<?php echo $row['paperid'];?>" onclick="return confirm('Do You wanto delete')"
