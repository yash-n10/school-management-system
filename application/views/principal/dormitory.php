                    ...
                    <tbody>
                        ...
                        <tr>
							...
							<td align="center">
                            	...
                            	<a data-toggle="modal" href="#modal-delete" onclick="modal_delete('<?php echo base_url();?>principal/dormitory/delete/<?php echo $row['dormitory_id'];?>')" class="btn btn-red btn-small">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td align="center">
                                ...
                                <a data-toggle="modal" href="#modal-delete" onclick="modal_delete('<?php echo base_url();?>principal/dormitory/delete_room/<?php echo $row['room_id'];?>')" class="btn btn-red btn-small">
                                        <i class="icon-trash"></i> <?php echo get_phrase('delete');?>
                                </a>
                            </td>
                        </tr>
...
<script type="text/javascript">
  ...
  $('#class_id').on('change',function(){
	...
	$.ajax({
							type: 'POST',
							url: '<?php echo base_url(); ?>principal/dor_stn_data/',
  ...
  $('#dormitory_name').on('change',function(){
		...
		$.ajax({
							type: 'POST',
							url: '<?php echo base_url(); ?>principal/dryname_chk/',
   ...
   $('#room_name').on('change',function(){
		...
		$.ajax({
							type: 'POST',
							url: '<?php echo base_url(); ?>principal/rmname_chk/',
