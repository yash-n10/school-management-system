<div class="tab-pane box active" id="edit" style="padding: 5px">
    <div class="box-content">
        ...
        <?php echo form_open('principal/classnoticeboard/do_update/'.$row['notice_id'] , array('class' => 'form-horizontal validatable','target'=>'_top'));?>
            <div class="padded">
				...
				<div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text" class="validate[required]" name="notice_title" value="<?php echo $row['notice_class'];?>"/>
                    </div>
                </div>
                <div class="control-group">
