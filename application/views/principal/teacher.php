            ...
            <div class="box">
                ...
                <div class="box-content padded tam-custom-border1">
                   ...
                   <center>
                    ...
                    <select name="department_id" onchange="window.location='<?php echo base_url(); ?>principal/teacher/'+this.value">
		...
		<div class="tab-content">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td align="center">
                                            ...
                                            <a data-toggle="modal" href="#modal-delete" onclick="modal_delete('<?php echo base_url();?>principal/teacher/delete/<?php echo $row['teacher_id'];?>')"
			...
			<div class="tab-pane box" id="add" style="padding: 5px">
                <div class="box-content">
                    ...
                    <form method="post" action="<?php echo base_url();?>principal/teacher/create/" class="form-horizontal validatable" enctype="multipart/form-data">
                        <div class="padded">
...
<script>
	...
	$('#emp_code_val').on('change',function(){
		...
		$.ajax({
							type: 'POST',
							url: '<?php echo base_url(); ?>principal/tchcodecheck/',
							data: { chkcode:tcode },
	...
	$('#teacher_uname_val').on('change',function(){
		...
		$.ajax({
							type: 'POST',
							url: '<?php echo base_url(); ?>principal/tchemailcheck/',
							data: { chkmail:temail },
							success: function(data) {
								//alert(data);
	...
	$('#teacher_email_val').on('change',function(){
		...
		$.ajax({
							type: 'POST',
							url: '<?php echo base_url(); ?>principal/tchtemailcheck/',
							data: { chkmail:temail },
							success: function(data) {
								//alert(data);
