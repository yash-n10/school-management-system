			...
			<div class="tab-pane box active" id="list" style="padding: 5px">
                <div class="box-content padded">
                    ...
                    foreach($edit_data as $row):
                        ?>
                        <?php echo form_open('principal/manage_profile/update_profile_info' , array('class' => 'form-horizontal validatable','target'=>'_top'));?>
		...
		<div class="tab-content">
			...
			<div class="tab-pane box active" id="list" style="padding: 5px">
                <div class="box-content padded">
                    ...
                    foreach($edit_data as $row):
                        ?>
                        <?php echo form_open('principal/manage_profile/change_password' , array('class' => 'form-horizontal validatable','target'=>'_top'));?>
                            <div class="control-group">
