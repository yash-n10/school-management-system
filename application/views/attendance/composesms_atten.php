                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-3">
                        <select class="form-control" name="sms_to" id="sms_to" onchange="mail_to_change(this)">
                            ...
                            <option value="teaching_staff" <?php echo  set_select('sms_to', 'teaching_staff'); ?>>Present Students</option>
                            <option value="non_teaching_staff" <?php echo  set_select('sms_to', 'non_teaching_staff'); ?>>Absent Students</option>
