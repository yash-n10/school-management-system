	...
	<div class="box-content padded">
		<div class="tab-content">            
                    ...
                    <tbody>
						...
						for($i = 1; $i<= 7; $i++):
							...
							<tr>
								...
								<td align="center">
									<a href="<?php echo base_url();?>teacher/backup_restore/create/<?php echo $type;?>" 
										class="btn btn-gray" rel="tooltip" data-original-title="download backup"><i class="icon-download-alt" ></i>
											Download Backup</a>
									<a href="<?php echo base_url();?>teacher/backup_restore/delete/<?php echo $type;?>" 
            ...
            <div class="tab-pane box  span6" id="restore">
                ...
                <form method="post" enctype="multipart/form-data" action="<?php echo base_url();?>teacher/backup_restore/restore">
