...
$('#fee_collect_class_id').on('change',function(){
	...
	$.ajax({
							type: 'POST',
							url: '<?php echo base_url(); ?>teacher/fee_collect_get_student/',
...
function call_data_load(){
	...
	$.ajax({
							type: 'POST',
							url: '<?php echo base_url(); ?>teacher/fee_collect_get_data/',
...
$(document).on('click','.custom-fee-pay-his-btn',function(e){
	...
	$('#custom-tam-model-body-pay-his').text('');
		...
		$.ajax({
							type: 'POST',
							url: '<?php echo base_url(); ?>teacher/fee_pay_history/',
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$("#fee_collect_frm").validate({
			...
			submitHandler: function(form) {
				...
				$.post('<?php echo base_url(); ?>teacher/fee_collect_process_data/', $("#fee_collect_frm").serialize(), function(data) {
	...
	function call_open_receipt(receipt_id){
		...
		var url = '<?php echo base_url(); ?>teacher/generatereceipt/'+receipt_id;
