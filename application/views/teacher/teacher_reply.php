<div class="box">
    ...
    <div class="box-content padded">
        <div class="tab-content">       
            ...
            <div class="container center-container" style="width:1086px !important">
                                                ...
                                                <li id="connection_<?php echo $message->user_id; ?>" class="round <?php echo $class; ?>" style="cursor:pointer;height:65px">
                                                    <div class="img-container">
                                                        <a class="img-link" href="javascript:void(0);" rel="">
                                                            <img src="<?php echo base_url().'template/images/parent.png' ?>" width="45px" height="51px"/>
                                                        </a>
                                                    </div>
                                                    <div class="data-container">
                                                        <h2 class="silver"><?php echo $message->sname."'s parent"; ?></h2>
