			...
			<div class="nav-collapse nav-collapse-top collapse">
				<ul class="nav full pull-right">
					...
					<ul class="dropdown-menu">
						<li><a href="<?php echo base_url();?>parents/manage_profile"><i class="icon-user"></i><span><?php echo get_phrase('profile');?></span></a></li>
						<li><a href="<?php echo base_url();?>parents/system_settings"><i class="icon-cog"></i><span><?php echo get_phrase('settings');?></span></a></li>
