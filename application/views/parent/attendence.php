		...
		<ul class="nav nav-tabs nav-tabs-left">
			...
			<li class="active">
            	...
            	<a href="#list" data-toggle="tab"><i class="icon-align-justify"></i> 
					...
					<?php echo get_phrase('view_monthly_attendence');?>
                    	</a></li>
                ...
                <table class="table table-normal box" >
                    ...
                    <tbody>
                        ...
                        <tr>
							...
							<td><?php echo get_phrase('total_working_days');?></td>
						...
						foreach($students as $row):
							...
							<tr>
								...
								<td style="text-align:left;">
									...
									<?php echo date("F",mktime(null, null, null,$row2['month']));?>

								</td>
                                <td style="text-align:right;">
                                	
                                    <?php $verify_data1	=	array('work_id' => $row2['month'] );
