			...
			<div class="col-lg-12">
				<?php if(substr($right_access,0,1)=='C'){?>
					<div class="col-lg-12" style="text-align:right;">
						<a type="button" class="btn btn-add" title="Add Outstandings" style="float:right; font-weight:bold; " href="<?php echo site_url('store/addoutstanding/add_bill');?>">
							<i class="fa fa-plus fa-lg"></i>&nbsp;&nbsp;Add Outstandings</a>
					...
					<table id="itemdetailslist" class="table table-bordered table-striped dTable">
						<thead style="background:#99ceff;">
							<tr>
								...
								<th style="border-bottom:0px; width:11%;">Outstanding Amount</th>
