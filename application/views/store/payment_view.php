...
<a class="button">TOTAL AMOUNT IN WALLET <br> <?php echo $wallet; ?></a>
<br><br>
<form method="POST" action="<?php echo base_url();?>/store/Payment/request">
Enter The amount you want to pay: <input type="number" name="amount" id="amount" value="<?php echo $amount;?>" required >
<br>
<div class="col-md-4">	
...
?>
<td>Challan No:<?php echo $key->remarks?></td>
<?php }?>
...
$query2=$this->db->query("SELECT * FROM store_bill_hdr where admission_no='$admission_no' and final_status='APPROVED'");
