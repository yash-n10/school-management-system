					...
					<form id="formm">
						<table class='table table-striped dTable' style="border-collapse: collapse;" id='mytbl'>
							<tr style="background:#00c0ee; color:white; padding:1px;">
								...
								<th style="width:15%; border: 1px solid white; align:center;">Outstandings</th>
...
<script>
	...
	function save() {
				if(!$('#formm')[0].checkValidity()) {
						...
						url = "<?php echo site_url('store/addoutstanding/saveRecs')?>";
						...
						({
								...
								success: function(data) {
									if(data == 1) {
										...
										window.location='/store/addoutstanding';
									}
									if(data == 0) {
