<div class="form-group has-feedback">
    <div class="box">            
        ...
        <div class="box-body">
            <form id="form_led" action="<?php echo base_url('account/Acc_ledger/acc_report'); ?>" method="post">       
                <div class="row">
                        ...
                        <table class="table table-striped table-bordered">
                            ...
                            <tr>
                                ...
                                <select class="form-control" name="ledger_name" id="ledger_name" style="width:220px;">
                                    ...
                                    <?php foreach ($ledger as $ledger_name_value) { ?>
                                        <option value="<?php echo $ledger_name_value->id; ?>"><?php echo $ledger_name_value->ledger_name; ?></option>
                                    <?php } ?>
                                </select>
                            </center>
                            </td>
