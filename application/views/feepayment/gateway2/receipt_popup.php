          ...
          <div class="modal-header">
            ...
            <div class="row"  style="border-bottom:1px solid gray; padding:5px;">
                ...
                <div class="row" >
                 ...
                 <div class="row" >
                     <div class="col-sm-3">Category </div> <div class="col-sm-3">:<?php echo  $cat;?> </div>  
                 </div>
            ...
            <div class="row" style="border-bottom:1px solid gray;">
                ...
                ?>               
                        ...
                        <div class="row" style="">
                            <div class="col-sm-6" style="text-align:center; border-right:1px solid grey"> <?php echo $obj_pdf->fee_name;?></div>
                            <div class="col-sm-6" style="text-align:center; border-right:1px solid grey"> <?php echo $fee;?> </div>
                        </div>
                    <?php 
                    }
                }
                ...
                <div class="row" style="">
                        <div class="col-sm-6" style="text-align:center; border-right:1px solid grey"> <?php echo $readmsnfine_fee[0]->fee_name;?></div>
                        <div class="col-sm-6" style="text-align:center; border-right:1px solid grey"> <?php echo $readmsnfine_fee[0]->fee_amount;?> </div>
                </div>
               <?php }
                ...
                if($this->session->userdata('school_id')==35){
                    ...
                    <div class="row" style="">
                        <div class="col-sm-6" style="text-align:center; border-right:1px solid grey">Instant Discount</div>
                        <div class="col-sm-6" style="text-align:center; border-right:1px solid grey"> <?php echo $discount;?> </div>
                    </div>
                <?php } ?>
                <?php } ?>
