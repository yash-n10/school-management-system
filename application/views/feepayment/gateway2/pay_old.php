                    ...
                    <div class="col-md-4">
                        <div class="box" style="border: 1px solid darkgrey;">
                            <form class="form-horizontal" method="POST" role="form" id="anual_paym" action="<?php echo base_url("payment/request") ?>">
                                <div class="box-header with-border" style="">
                                    <h3 class="box-title">Annual Fee<?php if (count($annual_fee_paid) == 0) { ?> [UNPAID]  <?php } ?></h3>
                                </div>
                                <div class="box-body">
        ...
        <div class="modal fade" id="modal_trans_charges" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <form class="form-horizontal" id="change_initial_password" method="POST" role="form" action="<?php echo base_url("payment/request"); ?>">
...
<!--                                <div class="form-group" style="margin-bottom: 0px !important;">
                            ...
                            <p id="change_initial_error" style="color:darkblue"><span class="span">Note: </span>1. There may be a transaction and service charge deduction of 1.25% on all Debit cards and 1.45% on all Credit cards on each transaction done.</p>
