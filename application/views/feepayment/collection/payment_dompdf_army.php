    ...
    <table style="width: 100%;">
      ...
      <?php if($transport_fee>0) {
       ...
       <tr>
          ...
          <th class=" tablebottom tabletop" style="text-align: left;padding-left: 10px;"> <span style="color: #585858;font-weight: 10px;"> <?php echo $transport_fee; ?> </span> </th>
          <th class="tabletop tablebottom"></th>
      ...
      <?php 
       ...
       <tr>
          ...
          <th class=" tablebottom tabletop" style="text-align: left;padding-left: 10px;"> <span style="color: #585858;font-weight: 10px;"> <?php echo $readmsnfine_fee[0]->fee_amount; ?> </span> </th>
          <th class="tabletop tablebottom"></th>
      ...
      <?php if($discount>0) {
       ...
       <tr>
          ...
          <th class=" tablebottom tabletop" style="text-align: left;padding-left: 10px;"> <span style="color: #585858;font-weight: 10px;"> <?php echo $discount; ?> </span> </th>
          <th class="tabletop tablebottom"></th>
