                    ...
                    <div class="col-lg-12" id="">
                        <fieldset>
                            ...
                            <?php for($pm=1;$pm<=12;$pm++){?> 
                                                <div class="btn col-sm-2 col-md-2 col-xs-3" style="padding: 6px 6px;width:42px ;font-weight: bold;<?php if($pm<=$paid_month){ echo 'background-color:#85e085;color: green;';}else{echo 'background-color:#ff6161;color: white;';}?>;margin: 1px"><?php echo $month[$pm];?></div>
                            <?php }?>
                                                ...
                                                <tbody>
                                                    ...
                                                    foreach($fees2 as $hy_fee){
                                                        ...
                                                        <tr id="row<?php echo $hy_fee->fee_id?>">
                                                                ...
                                                                <td>
                                                                    <?php $e=explode(',',$hy_fee->month_set); $stre='';
                                                                        foreach ($e as $ev) {
                                                                            $stre.=$month[$ev].', ';
                                                                        } 
                                            ...
                                            <tbody>
                                                <?php foreach($fetch_instant_fees_det1 as $insfee){?>
                                                    <tr id="otherrow<?php echo $insfee->fee_id?>"> 
                                                        ...
                                                        <th <?php if($insfee->paid_status==1){ echo 'style="background: #85e085";color: green;';}else{ echo 'style="background: #ff6161;color:#fff;"';}?>><?php if($insfee->paid_status==1){echo 'Paid';}else{ echo 'Unpaid';}; ?></th>
                                            ...
                                            <tbody>
                                                <?php foreach($other_fees as $othrfee){?>
                                                    <tr id="otherrow<?php echo $othrfee->fee_id?>"> 
                                                        ...
                                                        <td>
                                                            <?php if(!empty($othrfee->month_set)) {$e1=explode(',',$othrfee->month_set); $stre1='';
                                                                        foreach ($e1 as $ev1) {
                                                                            $stre1.=$month[$ev1].', ';
                                                                        } 
            ...
            <table class="table table-striped table-bordered" style="margin:0px;width:100%" id="list1" >
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php if($paid_status[$t]==1){ echo 'Paid';}else if($paid_status[$t]==0 && $charge_back[$t]==1){ echo 'ChargeBack Applied';} else{ echo 'UNPAID';};?></td>
                                <td> 
...
<!--                            <td class="col-sm-1"><input type="checkbox" name="fee_head[4]" id="chk_4" value="4"></td>
                ...
                <fieldset>
                    ...
                    <!--<table class="table" style="border:0px !important">-->
                        <div class="row form-group">
                            ...
                            <div class="col-sm-5"><input type="date" name="payment_date" class="form-control" style="padding:0px;padding-left:2px" value="<?php echo date("Y-m-d");?>" required></div>
                        </div>
                        <div class="row form-group">
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-sm-3"></div>
                            <div class="col-sm-5"><textarea  name="remarks" required="" class="form-control" style="padding:0px;padding-left:2px"></textarea></div>
                        </div>                        
                        <div class="row form-group">
                            <div class="col-sm-1"> 6.)</div>
                            <div class="col-sm-6"><b>Whether want to generate automatic receipt no.</b>(Yes/No)</div>
                            <!--<div class="col-sm-3"></div>-->
                            <div class="col-sm-5">
                        ...
                        <div class="row form-group" id="auto_receipt_div">
                            <div class="col-sm-1"> 7.)</div>
                            <div class="col-sm-6"><b>Receipt No.</b> (In case don't want to generate automated Receipt No.)</div>
                            <!--<div class="col-sm-3"></div>-->
                            <div class="col-sm-5"><input type="text"  name="receipt_no" class="form-control" style="padding:0px;padding-left:2px"></div>
                        </div>
                    <!--</table>-->
                </fieldset>
            ...
            <div class="modal-footer">
                <button class="btn btn-success" id="collectmodel" type="button">Collect</button>
            </div>
           </form>
          </div>
            ...
            if(isChecked) 
            {
                    if(id==2) 
                    {
                        ...
                        $('#noofmonth').keyup(function()
                        {
                                ...
                                var mn=month_no;
                                if(school_id==24 && paid_month<3 && month_no>=(3-paid_month)){
                                    fee_amt=fee_amt-transfee;
                                    mn--;
                                }
                                if(school_id==29 && paid_month<3 && month_no>=(3-paid_month)){
                                    fee_amt=fee_amt-transfee;
                                    mn--;
                                }
                                if(school_id==25 && paid_month<2 && month_no>=(2-paid_month)){
                                    fee_amt=fee_amt-transfee;
