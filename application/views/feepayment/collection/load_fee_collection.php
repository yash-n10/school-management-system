...
<div id="fee_collect_div_n">
    ...
    <div class="panel  panel-info">
        ...
        <div class="panel-body" style="padding:0px;">
            <?php //if (substr($right_access, 0, 1) == 'C' && ($stud_acedemic_session_id == $active_acedemic_session[0]->fin_year) || $active_=='U') { ?>
                <div class="row" >
...
<?php } ?>
            ...
            <div class="col-md-6" style="padding:1%">
                <div class="box " style="border: 1px solid lightgrey;">
                    <div class="box-header" style="background: aliceblue;padding:5px">
                        <h4 class="box-title" >Text Book Fees</h4>
                          ...
                          <div id="month" class='row'>
                                <div class="col-lg-12">
                                    <?php foreach($other_fee_paid as $of) {
                                     ...
                                     ?> 
                                        <button class="btn btn-success" style="width:30%">PAID <?php echo $fee_name; ?></button>
                                    <?php } ?>
                        ...
                        <tr>
                            ...
                            <td> 
                                <?php if ($paid_status[$t] == 1) { ?>
                                    <?php if(($this->id==29 && $fee_trans_head_id[$t]==82791) || ($this->id==29 && $fee_trans_head_id[$t]==82865) || ($this->id==29 && $fee_trans_head_id[$t]==82409) || ($this->id==29 && $fee_trans_head_id[$t]==83175) || ($this->id==29 && $fee_trans_head_id[$t]==83173)|| ($this->id==29 && $fee_trans_head_id[$t]==109956) || ($this->id==29 && $fee_trans_head_id[$t]==109957)|| ($this->id==29 && $fee_trans_head_id[$t]==110606) || ($this->id==29 && $fee_trans_head_id[$t]==110603)|| ($this->id==29 && $fee_trans_head_id[$t]==110620)){?>
                                    ...
                                    <?php if(($this->id==29 && $fee_trans_head_id[$t]==82791) || ($this->id==29 && $fee_trans_head_id[$t]==82865) || ($this->id==29 && $fee_trans_head_id[$t]==82409) || ($this->id==29 && $fee_trans_head_id[$t]==83175) || ($this->id==29 && $fee_trans_head_id[$t]==83173)|| ($this->id==29 && $fee_trans_head_id[$t]==109956) || ($this->id==29 && $fee_trans_head_id[$t]==109957)|| ($this->id==29 && $fee_trans_head_id[$t]==110606) || ($this->id==29 && $fee_trans_head_id[$t]==110603)|| ($this->id==29 && $fee_trans_head_id[$t]==110620)){?>
                                    <?php }else{ ?>
                                        <a class="btn" href="<?php echo base_url("feepayment/collection/Payment_pdf/payment_pdf/$fee_trans_head_id[$t]/$student_id"); ?>" style="color:#555285;padding:1px" title="2 Copy Receipt Download" target="_blank"><i class="glyphicon glyphicon-circle-arrow-down"> </i> </a>
                                    <?php } ?>
                                    <?php
                                    if (substr($right_access, 2, 1) == 'U') {
                                        if ($collection_centre[$t] != 'FCLB') { ?>
                                    <a class="btn" onclick="editTransaction(this, '<?php echo trim($remarks[$t]); ?>', '<?php echo $mode[$t]; ?>', '<?php echo $bank_name[$t]; ?>', '<?php echo date('Y-m-d', strtotime($payment_date[$t])); ?>', '<?php echo $amount[$t]; ?>','<?php echo $pos_no[$t]; ?>')" style="color:green;padding:0px" title="Edit" id="<?php echo $fee_trans_head_id[$t]; ?>"><i class="glyphicon glyphicon-pencil"> </i></a>

                                    <?php 
                                    // echo 'collll'.$olddd;
                                    if(($this->session->userdata('school_id')==35) && ($collection_centre[$t] != 'OLD')) { ?>
                ...
                <h4 class="modal-title">Fee Collection <center> <span style="color:#010d6d">Admission No.: <b><?php echo $admission_no; ?></b></span> <span style="color:#010d6d">Student name : <b><?php echo $student_name; ?></b></span> <span style="color:#010d6d">Class & Sec : <b><?php echo $class . ' ' . $section; ?></b></span></center></h4>
                    ...
                    <center><fieldset>
                        ...
                        <div class="row">
                          ...
                          <div class="col-sm-8">
                              <?php for ($pm = 1; $pm <= 12; $pm++) { ?> 
                                <center><div class="btn col-sm-2 col-md-2 col-xs-3" style="padding: 0px 1px;width:42px ;<?php
                                        if ($pm <= $paid_month) {
                                            echo 'background-color:#85e085;color: green;';
                                        }elseif ($pm>$paid_month && $pm<=$paid_month+$chqpaid_month) {
                                            echo 'background-color:#fbd222;color: black;';
                    ...
                    <fieldset>
                        <table class="table table-hover" style="margin-bottom:0px">
                            ...
                            <tbody>
                                ...
                                if ($onetime_avai == 'YES' && $student_type!='EXISTING') {
                                    if ($paid_status3 == 0) {
                                        ...
                                        <tr class="row">
                                            ...
                                            <td class="col-sm-3"><label for="chk_9">Onetime Fees</label></td>
                                            <td class="col-sm-4">
                                            </td>
                                            <td class="col-sm-4">
                                ...
                                ?>
                                <?php if($paid_month!=12) { ?>

                                <tr class="row" id="monthlyfee">
                                    <td class="col-sm-1">
                                        <input type="checkbox" name="fee_head[2]" id="chk_2" value="2"></td>
                                    <td class="col-sm-3"><label for="chk_2">Monthly Fees</label></td>
                                    <td class="col-sm-4"><?php $max_mnth = 12 - $paid_month ?>
                                        <input type="number" name="noofmonth" class="form-control" disabled="true" id="noofmonth" required placeholder="Enter No. of Month" min="1" max="<?php echo $max_mnth; ?>" style="padding: 0px;padding-left:3px" oninvalid="this.setCustomValidity('<?php echo $max_mnth; ?> months are Unpaid. Values must be less than or equal to <?php echo $max_mnth; ?>.')" oninput="setCustomValidity('')" onchange="cal_amt()">
                                    </td>
                            ...
                            if ($fee_type2 == 4) {
                                if ($paid_status2 == 0) {
                                    ...
                                    <tr class="row">
                                        ...
                                        <td class="col-sm-3"><label for="chk_1">Annual Fees</label></td>
                                        <td class="col-sm-4">
                                        </td>
...
?>
                            <tr class="row" id="othrowmonthly">
                                ...
                                <tr class="row" id="othrow">
                                    ...
                                    <td class="col-sm-3"><label for="chk_3">Text Book Fees</label></td>
                                    <td class="col-sm-4">
                                ...
                                <?php foreach ($fetch_other_fees_det_withoutmonth as $othrfee) { ?>
                                                <tr>
                                                    ...
                                                    <td><label for="oth_fee<?php echo $othrfee->fee_id ?>"><?php echo $othrfee->fee_desc; ?></label></td>
                                                    <td><?php echo $othrfee->fee_amount; ?></td>
                                                </tr>
                                            <?php } ?>
                                        </table>
...
<?php if (count($fetch_instant_fees_det) > 0) { ?>
                                <tr class="row" id="instant_fee_misc">
                                    ...
                                    <td class="col-sm-3"><label for="chk_8">Instant/Misc. Fees</label></td>
                                    <td class="col-sm-4">
                                ...
                                <?php foreach ($fetch_instant_fees_det as $instfee) { ?>
                                                ...
                                                <!--<input type="hidden" value="<?php // echo $instfee->id  ?>" name="instantfeemainid[]">-->
                                                    ...
                                                    <td><label for="instant_fee<?php echo $instfee->fee_id ?>"><?php echo $instfee->fee_desc; ?></label></td>
...
<?php if ($readmsnfineamt != 0) { ?>
                                <tr class="row">
                                    ...
                                    <td class="col-sm-3" id="re_admission_fine"><label for="chk_11">Re-Admission-Fine</label></td>
                                    <td class="col-sm-4">
                                    </td>
...
<?php } ?>
                            <tr class="row">
                                ...
                                <td class="col-sm-3" id="instant_discount"><label for="chk_7">Fine Waiver</label></td>
                                <!-- <td class="col-sm-3" id="instant_discount"><label for="chk_7">Instant Discount</label></td> -->
                                <td class="col-sm-4">
                                </td>
                    ...
                    <fieldset>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <?php if(($this->session->userdata('school_id')==35) && ($this->session->userdata('user_id')==5310)) { ?>
                                    <div class="col-sm-4">
                                    <label for="email"><b>Collection Center</b></label>
                                    <select class="form-control" name="collection_center" required>
                                        <!-- <option value="">Select</option> -->
                                        <?php foreach ($collection_centers_c1 as $cc) { ?>
                                        <option value="<?php echo $cc->collection_code ?>"><?php echo $cc->collection_desc; ?></option>
                                        <?php } ?>
                                    </select>                                
                                </div>
                                <?php } else if(($this->session->userdata('school_id')==35) && ($this->session->userdata('user_id')==5311)) { ?>

                                    <div class="col-sm-4">
                                    <label for="email"><b>Collection Center</b></label>
                                    <select class="form-control" name="collection_center" required>
                                        <!-- <option value="">Select</option> -->
                                        <?php foreach ($collection_centers_c2 as $cc) { ?>
                                        <option value="<?php echo $cc->collection_code ?>"><?php echo $cc->collection_desc; ?></option>
                                        <?php } ?>
                                    </select>                                
                                </div>
                                <?php } else if(($this->session->userdata('school_id')==35) && ($this->session->userdata('user_id')==5312)) { ?>
                                    <div class="col-sm-4">
                                    <label for="email"><b>Collection Center</b></label>
                                    <select class="form-control" name="collection_center" required>
                                        <!-- <option value="">Select</option> -->
                                        <?php foreach ($collection_centers_c3 as $cc) { ?>
                                        <option value="<?php echo $cc->collection_code ?>"><?php echo $cc->collection_desc; ?></option>
                                        <?php } ?>
                                    </select>                                
                                </div>
                                <?php } else if(($this->session->userdata('school_id')==35)) { ?>
                                     <div class="col-sm-4">
                                    <label for="email"><b>Collection Center</b></label>
                                    <select class="form-control" name="collection_center" required>
                                        <option value="">Select</option>
                        ...
                        <div class="row" id="pos_div" style="display: none">
                            <div class="col-sm-12">
                                <div class="col-sm-4">
                                    ...
                                    <input type="text"  name="pos_no" id="pos_no" class="form-control">
                                </div>
                            </div>
                        </div>
                ...
                <div class="modal-body">
                    ...
                    <fieldset>
                        ...
                        <div class="row form-group" id="row_tot_amount_update">
                            ...
                            <div class="col-sm-3"></div>
                            <div class="col-sm-5"><input type="number" name="tot_amount_update" id="tot_amount_update" class="form-control" style="padding:0px;padding-left:2px" value="" required readonly></div>
                        </div>
                       ...
                       <div class="row form-group" style="display: none" id="pos_div_edit">
                         <div class="col-sm-1">3.)</div>
                            <div class="col-sm-3"><b>POS No.</b></div>
                            <div class="col-sm-3"></div>
                            <div class="col-sm-5">
                                    <input type="text"  name="pos_no_edit" id="pos_no_edit" class="form-control">
                            </div>
                            </div>
...
<?php } ?>
                    ...
                    <div class="row form-group" style="padding-top:3%;display:none" id="reasondiv">
                        <!--                        <div class="col-sm-1"></div>-->
                        <div class="col-sm-4" style="text-align:right" id=""><b>Reason for Cancellation</b></div>
                        <!--                        <div class="col-sm-3"></div>-->
                ...
                <div class="modal-footer">
                    ...
                    <button class="btn btn-danger" id="deletecollectmodel" type="button" style="display:none">Cancel Receipt</button>
                </div>
            </form>
        </div>
    </div>
...
<script>
    ...
    var stud_acedemic_session_id = "<?php echo $stud_acedemic_session_id; ?>";
        ...
        if (isChecked)
        {
            if (id == 2)
            {
                ...
                $('#noofmonth').keyup(function ()
                {
                    ...
                    var mn = month_no;
                    if ((school_id == 24 || school_id == 29 || school_id == 35) && paid_month < 3 && month_no > (3 - paid_month)) {
                        fee_amt = fee_amt - transfee;
                        mn--;
                    }

                    if ((school_id == 25 || school_id==26 || school_id==38) && paid_month < 2 && month_no >= (2 - paid_month)) {
                        fee_amt = fee_amt - transfee;

                        mn--;
                    }
                    if(school_id == 35){
                        if(((class_id==10) || (class_id==12)) && ((paid_month < 12) && (month_no >= 12 - paid_month))) {    //March
                        fee_amt = fee_amt - transfee;
                        mn--;
                        }
                    ...
                    // if(school_id == 25){
                    //     if(((class_id==13) || (class_id==15)) && ((paid_month < 12) && (month_no >= 12 - paid_month))) {    //March
                    //     fee_amt = fee_amt - transfee;
                    //     mn--;
                    //     }
                    ...
                    // if(school_id == 29){
                    //     if(((class_id==13) || (class_id==15) || (class_id==16) || (class_id==17)) || ((paid_month < 12) && (month_no >= 12 - paid_month))) {    //March
                    //     fee_amt = fee_amt - transfee;
                    //     mn--;
                    //     }
...
//            alert(colIdx);
    ...
    function cal_amt()
    {
        ...
        $('#frmcollectfee input[name^=fee_amt]').each(function ()
        {
            ...
            {
            	var fine_amount=$('#fee_fine').val();
                tot_amt = tot_amt - Number($(this).val());
                finnnee_amt=fine_amount- Number($(this).val());
                $('#fee_fine').val(finnnee_amt);
                // tot_amt = fine_amount - Number($(this).val());
            } else
            {
                tot_amt = tot_amt + Number($(this).val());
            }
...
//            alert($(this).validationMessage);
            ...
            if (r == true)
            {
                ...
                var formdata = $('#frmcollectfee').serialize() + "&student_id=" + student_id + "&admission_no=" + admission_no + "&stud_cat=" + category_id + "&class_id=" + class_id + "&class_fee_head_id=" + class_fee_head_id + "&fee_session_year=" + fee_session_year + "&course_id=" + course_id +"&stud_acedemic_session_id=" + stud_acedemic_session_id;;
    ...
    function editTransaction(me, remarks = '', mode = '', bank = '', date = '', amount = 0,pos_no) {
...
<?php if($this->session->userdata('school_id')==35) { ?>
    ...
    $('#mode_payment').change(function () {
        if (this.value == 'POS') {
            ...
            $('#pos_no').attr('required','required');
        } else
        {
            $('#pos_div').css('display', 'none');
            $('#pos_no').removeAttr('required');
        }
    });
<?php } ?>
...
<?php if($this->session->userdata('school_id')==35) { ?>
    ...
    $('#edit_mode_payment').change(function () {
        if (this.value == 'POS') {
            $('#pos_div_edit').css('display', 'block');
            $('#pos_no_edit').attr('required','required');
        } else
        {
            $('#pos_div_edit').css('display', 'none');
            $('#pos_no_edit').removeAttr('required');
        }
    });
<?php } ?>
