...
//    print_r($errors);
        ...
        <div class="col-sm-12 col-md-12" style="padding-bottom:2%;color:red;font-weight: bold">
        
        <?php // echo $message;?>
        </div>
        <div class="col-lg-12" style="background:wheat;padding:0px;border-radius: 20px; " >
        <ul class="nav nav-pills" style="padding-left:20px">
        <li class="active"><a data-toggle="pill" href="#fee_collect"><i class="glyphicon glyphicon-plus"> </i>FEE COLLECT</a></li>
        <li class=""><a data-toggle="pill" href="#upload_fee_collect"><i class="glyphicon glyphicon-upload"> </i>UPLOAD FEES COLLECTION</a></li>
                        ...
                        <div class="panel  panel-default">
                            ...
                            <div class="panel-heading" style="padding: 5px 15px;">
                                ...
                                <ul class="nav nav-tabs" id="menu" style="display: inline-block;list-style-type: none;margin:0px;padding-left: 2%;border-bottom: 0px">
                                    ...
                                    <li class=""><a data-toggle="tab" href="#class_wise" style="font-weight:bold;padding: 1px 10px;" class="btn">Class Wise</a></li>
                                     <!-- <li class=""><a data-toggle="tab" href="#session_wise" style="font-weight:bold;padding: 1px 10px;" class="btn">Admission No Wise ("FOR DIFFERENT SESSION")</a></li>  -->
                                                                              
                                </ul>
                                <a href="<?php echo base_url();?>feepayment/Indirect_income" class="btn btn-primary"><i class="fa fa-plus"> Indirect Income</i></a>
                            </div>
                            <div class="panel-body" style="padding:0px">
                                <div class="tab-content">
                                        ...
                                        <table class="table" style="border:0px;">
                                            <tr>
                                               ...
                                               <!--  <td style="border:0px;width:20%;">
                                                    ...
                                                    <select id="fee_session" name="fee_session" class="form-control">
                                                    <?php 

                                                        $academic_session=$this->db->query("SELECT id,session FROM accedemic_session where status='Y'");
                                                        $academic_session=$academic_session->result();
                                                        print_r($academic_session);
                                                        foreach ($academic_session as $key) {
                                                                ?>
                                                                <option value="<?php echo $key->id;?>"><?php echo $key->session; ?></option>
                                                       <?php
                                                        }
                                                        ?>
                                    ...
                                    <!-- <div class="tab-pane fade  in" id="session_wise"style="padding-top:2%">
                                        ...
                                        <table class="table" style="border:0px;">
                                            <tr>
                                                ...
                                                <th style="width:10%;border:0px;">Admission No </th>    
                                                <td style="border:0px;width:20%;">
                                                    <input type="text" id="session_admno" name="session_admno" class="form-control" value="<?= set_value('session_admno') ?>" style="width:100%">
                                                </td>
                                                <br>
                                                <th>Session</th>
                                                <td style="border:0px;width:20%;">
                                                ...
                                                <td style="border:0px;width:20%;">
                                                    ...
                                                    <?php 
                                                        ...
                                                        $class=$this->db->query("SELECT id,session FROM accedemic_session where status='Y'");
                                                        $class=$class->result();
                                                        // print_r($academic_session);
                                                ...
                                                <td style="border:0px;width:20%;">
                                                    ...
                                                    <?php 
                                                        ...
                                                        $course=$this->db->query("SELECT id,session FROM accedemic_session where status='Y'");
                                                ...
                                                <td style="border:0px;width:10%;">
                                                    <button type="button" class="btn btn-success" id="load_submit4" data-load="">Submit</button>
                                                </td>
                                                <td style="border:0px;width:50%;">
 ...
 -->
                ...
                <!--                        <div class="tab-pane fade" id="upload_fee_collect">
                
                
                <div class="" style="float:right;">
                <a type='button' class="btn btn-info" name='dwnld' id='dwnld' value='Download Format'></a>
                
                <a  class="btn btn-warning" id="download" href="<?php // echo base_url('feepayment/collection/Offline_payment/download_format'); ?>" style="margin-top: 5%">
                <span class="glyphicon glyphicon-download"> </span> Download format
                </a>
                
                <a  class="btn btn-info" id="download" href="<?php // echo base_url('feepayment/collection/Offline_payment/download_instruction'); ?>" style="background:#46b8da;margin-top: 5%">
                <span class="glyphicon glyphicon-download"> </span> Download Instruction
                </a>
                </div>
...
//                                                                      }
                ...
                <div class="col-lg-3">
                <input class="form-control" size='50' type='file' name='offln_payment_upload'>
