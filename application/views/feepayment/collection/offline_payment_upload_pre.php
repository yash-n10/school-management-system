                        ...
                        <div class="panel  panel-default">
                            ...
                            <div class="panel-heading" style="padding: 5px 15px;">
                                ...
                                <ul class="nav nav-tabs" id="menu" style="display: inline-block;list-style-type: none;margin:0px;padding-left: 2%;border-bottom: 0px">
                                    ...
                                    <li class="active"><a data-toggle="tab" href="#class_wise" style="font-weight:bold;padding: 1px 10px;" class="btn">Class Wise</a></li>
                                    <li class=""><a data-toggle="tab" href="#admsn_wise" style="font-weight:bold;padding: 1px 10px;" class="btn">Admission No Wise</a></li>                                           
                                </ul>
                            </div>
                            <div class="panel-body" style="padding:0px">
                                <div class="tab-content">
                                    <div class="tab-pane fade active in" id="class_wise">
                                    ...
                                    <div class="tab-pane fade" id="admsn_wise"style="padding-top:2%">
...
//                alert('hi');
            ...
            $.ajax({
                type: 'POST',
                url: '<?php echo base_url('feepayment/collection/offline_payment_previous/get_admsn_no'); ?>',
                data: {
                    class: $('#fee_class').val(),
...
<i class="glyphicon glyphicon-time">  </i> <b> <span style="color:black"> Transaction History</span></b>\n\
                ...
                $.ajax({
                    type: 'POST',
                    url: '<?php echo base_url('feepayment/collection/offline_payment_previous/load_student_fee_div'); ?>',
                    data:
                            {
                                class: class_load,
