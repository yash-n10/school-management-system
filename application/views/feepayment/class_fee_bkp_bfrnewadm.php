...
<div class="form-group has-feedback" id="load">
        <div class="box">
            ...
            <div class="box-body">
            <div class="col-lg-12">
              <div class="col-lg-12" style="text-align:right;"><button class="btn btn-add" id="add_class_fee" title="Add Class Fee"> <i class="fa fa-plus-circle fa-lg"></i> </button></div>
                          ...
                          <span>
                              ...
                              <input type="checkbox" class="btn " name="chk<?php echo $obj_fee->id?>" id="<?php echo $obj_fee->id?>">
                               <?php }?>
                                ...
                                <?php  if($obj_fee->year>$session_start_yr || ($obj_fee->year==$session_start_yr && $session_start_month==date('m'))||$this->session->userdata('school_id')==8){echo '<i class="fa fa-edit"></i> Edit';}else{ echo '<i class="fa fa-eye"></i>  View';}?>
