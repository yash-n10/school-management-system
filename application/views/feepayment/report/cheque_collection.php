            ...
            <form id="export-form" action="<?php echo base_url("feepayment/Report/exportpaymentlogcheque"); ?>" method="POST">
                <div class="col-sm-12 col-md-12">
                        ...
                        <div class="" style="float:right;" id="div_change">
                            <?php $date = date('Y-m-d'); ?>
                            <!--<a class="btn btn-success" id="paylog_export" href="<?php // echo base_url("feepayment/Report/exportpaymentlog/all/all/all/all"); ?>" download>-->
...
//        }
        ...
        function datatable()
        {
            ...
            $('#studentlist1').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: '<?php echo base_url('feepayment/Report/paymentlogcheque_report'); ?>',
                    type: 'POST',
...
function changestatus(id,amount){
    ...
    var total_amount=amount;
                    ...
                    $.ajax
                    ({
                        url: "<?php echo site_url('feepayment/report/update_cheque_collection_status') ?>",
                        type: "POST",
