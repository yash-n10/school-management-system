            ...
            <?php }?>
             ...
             <tbody id="daily_load_td">
                 ...
                 <?php } ?>
                  ...
                  <tr>
                    <td colspan="34">COLLECTION STATEMENT SUMMARY</td>
                 </tr>
                 <tr>
                    <td colspan="34">Total Cancelled Receipt : 0</td>
                 </tr>
                 <tr>
                    <td colspan="34">Amount Collected in Figures : Rs </td>
                 </tr>
                  <tr>
                    <td colspan="34">Amount Collected in Words :</td>
                 </tr>
                 <tr>
                    <td colspan="34">Total Amount Collected by Cash of Rs <?php echo $tot_mode; ?> , Collected POS </td>
                 </tr>
                  <tr>
                    <td colspan="34">Total Amount Collected by Cheque of Rs , Collected Online </td>
                 </tr>
                  <tr>
                    <td colspan="34">Amount Deposited in Bank : Rs_____________________________</td>
                 </tr>
                 <tr>
                    <td colspan="34">Date of Deposit : ____/____/__________</td>
                 </tr>
                  <tr>
                    <td colspan="34">Balance Cash in Hand : Rs_____________________________</td>
                 </tr>
