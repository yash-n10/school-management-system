                    ...
                    <div class="tab-content">
                        <div class="tab-pane fade active in" id="daily">
                            ...
                            <div class="col-sm-12" style="padding-top:1%;text-align:center">
                                ...
                                <div class="col-sm-3">
                                    <input type='date' class="form-control" id="inputdate1" value="" style="width:100%">
                                </div> 
                        ...
                        <div class="tab-pane fade" id="monthlyfees">
                            ...
                            <div class="col-sm-12" style="padding-top:1%;text-align:center">
                                ...
                                <div class="col-sm-2">
                                    <input type='date' class="form-control" id="inputdatemf" value="" style="width:100%">
                                </div> 
                                
                                <label class="control-label col-sm-2"> To Date</label>
                                <div class="col-sm-2">
                                    <input type='date' class="form-control" id="inputdatemt" value="" style="width:100%">
                                </div> 
                            </div>
...
//                    alert(data);
        ...
        $('#inputdatemf,'+'#inputdatemt,'+'#collection_center3').change(function ()
        {
