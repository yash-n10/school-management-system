                    ...
                    <div class="panel-body">
                        ...
                        <div class="col-sm-3 col-md-3">
                                        ...
                                        <table id="studentlist1" class="table table-bordered table-striped">
                                            ...
                                            <thead>
                                                ...
                                                <tr> 
                                                    ...
                                                    <th rowspan="2" style="border-bottom:1px solid black;"> Transaction Count </th>
                            ...
                            <div class="tab-pane fade" id="category">
                                ...
                                <label class="control-label col-md-2 col-sm-2">Session</label>
                                <div class="col-sm-3 col-md-3">
                                    <select name="aca_session_cat" id="aca_session_cat" class="form-control">
                                        <?php foreach ($asession as $ses) {?>
                                            <option value="<?php echo $ses->id; ?>"><?php echo $ses->session; ?></option>
                                            <?php } ?>
                                    </select>
                                ...
                                <div class="col-sm-12 col-md-12">
                                    ...
                                    <div class="col-sm-3 col-md-3">
                                        <select class="form-control" name="collection_center1" id="collection_center1">
                                            <option value="all">All</option>
                                            <?php foreach ($collection_center as $cc) { ?>
                                            <option value="<?php echo $cc->collection_code; ?>"><?php echo $cc->collection_desc; ?></option>
                                                <?php } ?>
                                        </select>
                                    </div> 
                            ...
                            <div class="tab-pane fade" id="classsect">
                                <div class="col-sm-12 col-md-12" style="padding-top:1%">
                                     <label class="control-label col-md-2 col-sm-2">Session</label>
                        <div class="col-sm-3 col-md-3">
                            <select name="aca_session_cls" id="aca_session_cls" class="form-control">
                                <?php foreach ($asession as $ses) {?>
                                    <option value="<?php echo $ses->id; ?>"><?php echo $ses->session; ?></option>
                                    <?php } ?>
                            </select>
                            ...
                            <div class="tab-pane fade in" id="feehead">
                                ...
                                <div class="col-sm-12 col-md-12" style="padding-top:1%">
                                     <label class="control-label col-md-2 col-sm-2">Session</label>
                        <div class="col-sm-3 col-md-3">
                            <select name="aca_session_head" id="aca_session_head" class="form-control">
                                <?php foreach ($asession as $ses) {?>
                                    <option value="<?php echo $ses->id; ?>"><?php echo $ses->session; ?></option>
                                    <?php } ?>
                            </select>
...
<script type="text/javascript">
    ...
    $(document).ready(function ()
    {
        ...
        $('aca_session' + ',#inputdate1' + ',#inputdate2' + ',#collection_center').change(function ()
        {
...
//         alert(from_date);
            $.ajax({
                ...
                url: '<?php echo base_url(); ?>feepayment/report/date_wise_term_report',
                dataType: "text",
                method: 'post',
                data: {
...
//                         $('#tabletitle').text(' DATE WISE TERM REPORT FROM '+from_date+' TO '+to_date);
                },
                error: function () {
        ...
        $('#aca_session_cat' +',#inputdate3' + ',#inputdate4' + ',#collection_center1').change(function ()
        {
            var aca_session_cat = $('#aca_session_cat').val();
...
//         alert(from_date);
            $.ajax({
                ...
                url: '<?php echo base_url(); ?>feepayment/report/category_wise_term_report',
                dataType: "text",
                method: 'post',
                data: {
                    aca_session_cat:aca_session_cat,
                    from_date: from_date,
                    to_date: to_date,
                    collection_center: collection_center
                },
...
//                      alert(data);
        ...
        $('#aca_session_cls' +',#inputdate5' + ',#inputdate6' + ',#collection_center2' + ',#categorylist3').change(function ()
        {

            var aca_session_cls = $('#aca_session_cls').val();
...
//         alert(from_date);
            $.ajax({
                ...
                url: '<?php echo base_url(); ?>feepayment/report/class_wise_term_report',
                dataType: "text",
                method: 'post',
                data: {
                    aca_session_cls: aca_session_cls,
                    from_date: from_date,
                    to_date: to_date,
                    category: category,
                    collection_center: collection_center
...
//                      alert(data);
        ...
        $('aca_session_head' +',#feedate4' + ',#feedate5' + ',#collection_center4').change(function ()
        {


            var aca_session_head = $('#aca_session_head').val();
...
//         alert(from_date);
            $.ajax({
                ...
                url: '<?php echo base_url(); ?>feepayment/report/feehead_wise_term_report',
                dataType: "text",
                method: 'post',
                data: {
                    aca_session_head: aca_session_head,
                    from_date: from_date,
                    to_date: to_date,
                    collection_center: collection_center
                },
