                    ...
                    <div class="col-sm-12 col-md-12">
						...
						<?php if($schoolgrp=='ARMY'){ ?>
                            ...
                            <select name="choosetillmonth" id="choosetillmonth" class="form-control">
                                ...
                                <option value="06" <?php if($m==4 || $m==5 || $m==6) echo 'selected=selected';?>>Quarter1</option>
                               <!--  <option value="06" <?php //if($m==5) echo 'selected=selected';?>>May</option>
                                ...
                                <option value="09" <?php if($m==7 || $m==8 || $m==9) echo 'selected=selected';?>>Quarter2</option>
                                ...
                                <option value="12" <?php if($m==10 || $m==11 || $m==12) echo 'selected=selected';?>>Quarter3</option>
                                ...
                                <option value="03" <?php if($m==1 || $m==2 || $m==3) echo 'selected=selected';?>>Quarter4</option>
                        ...
                        <tr>
                            ...
                            <th> Monthly ( <?php
                                if (date('Y-m-d') > $session_end_date) {
                                    ...
                                    echo 'Including Current Quarter';
                                }
                                ?>) </th>
...
// alert (term);
           table =  $('#studentlist').DataTable({
				...
				"lengthMenu": [[10, 50, 100,1000, 4000], [10, 50, 100,1000, 4000]],
                serverSide: true,
                dom: 'lfBrtip',
