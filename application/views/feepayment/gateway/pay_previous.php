...
<div class="form-group has-feedback">
    ...
    <div class="panel  panel-danger">
        <div class="panel-heading" style="padding: 5px 15px;color: white;background-color: #00c6f7;border-color: #fc9797;" style="font-weight:bold;font-size:18px"><i class="fa fa-inr">  </i> <b> <span style=""> Pay Fees</span></b><b style="text-align: center;color:red">Payment Due of Previous Session <?php echo $psession; ?></b>
        </div>
        <div class="panel-body">
            <?php if ($fee_type1 == 1) { ?>
                <div class="col-md-5">
                    <div class="box" style="border: 1px solid darkgrey;">
                        <form class="form-horizontal" method="POST" name="mont_paym" role="form" id="mont_paym" action="<?php echo base_url("Payment_Previous/request"); ?>">
                                ...
                                <table id="paymentlist" class="table table-bordered table-striped">
                                    <thead style="background-color: #fff!important;color: #000;">
                                        ...
                                        <tbody id="get_month_fee_det">                   
                                            ...
                                            $total = 0;
                                            $total1 = 0;
                                            // echo "<pre>";print_r($monthly_fee->result());die();
...
// }
                        ...
                        <?php if ($fee_type2 == 4) {
                            ...
                            <div class="col-md-4">
                                <div class="box" style="border: 1px solid darkgrey;">
                                    <form class="form-horizontal" method="POST" role="form" id="anual_paym" action="<?php echo base_url("payment_Previous/request") ?>">
                                        <div class="box-header with-border" style="">
                    ...
                    <?php } else {
                        ...
                        <div class="col-md-4">
                            <div class="box" style="border: 1px solid darkgrey;">
                                <form class="form-horizontal" method="POST" role="form" id="half_paym" action="<?php echo base_url("payment_Previous/request") ?>">
                                    <div class="box-header with-border" style="">
                    ...
                    <div class="col-md-5">
                        <div class="box" style="border: 1px solid darkgrey;">
                            <form class="form-horizontal" method="POST" role="form" id="other_paym" action="<?php echo base_url("payment_Previous/request") ?>">
                                <div class="box-header with-border" style="">
                                    <h3 class="box-title">Text Book Fee</h3>
                                </div>
                    ...
                    <div class="col-md-7">
                        <div class="box" style="border: 1px solid darkgrey;">
                            <form class="form-horizontal" method="POST" role="form" id="instant_paym" action="<?php echo base_url("payment_Previous/request") ?>">
                                <div class="box-header with-border" style="">
                                ...
                                <table id="list1" class="table table-bordered table-striped" style="width:100%">
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($transaction_history->result() as $payment) {
                                            ...
                                            $str = rtrim($str, ',');
                                            ?>
                                            <?php if(($this->id==29 && $payment->id==83028) ||($this->id==29 && $payment->id==83031) || ($this->id==29 && $payment->id==82409) || ($this->id==29 && $payment->id==83175) || ($this->id==29 && $payment->id==83173)) { ?>
                                                <tr>
...
<div class="modal fade" id="modal_trans_charges" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form class="form-horizontal" id="monthly_fee_popup" method="POST" role="form" action="<?php echo base_url("Payment_Previous/request"); ?>">
                <div class="modal-header" style="background: lightgoldenrodyellow;border-bottom: 1px solid gainsboro;">
                    ...
                    <h4 class="modal-title" style="color:red">Payment Due of Previous Session 2019-2020</h4>
                </div>
    ...
    <div class="modal fade" id="modal_trans_charges2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <form class="form-horizontal" id="" method="POST" role="form" action="<?php echo base_url("Payment_Previous/request"); ?>">
                    <div class="modal-header" style="background: lightgoldenrodyellow;border-bottom: 1px solid gainsboro;">

                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span class="span" aria-hidden="true">&times;</span></button>
                        <h4 class="modal-title" id="myModalLabel">Total amount</h4>
                        <h4 class="modal-title" id="">Previous Session Payment Due 2019-2020</h4>
                    </div>
                    <div class="modal-body" style="background:oldlace">
                        <div class="box-body edit_form">
                            <div class="form-group">
        ...
        <script>
            ...
            function get_pdfdet(trans_id)
            {
                ...
                $('#monthly_pay1').load('<?php echo base_url('Payment_Previous/btn_download_pop_load'); ?>' + '/' + 'dwld_no', {trans_id: trans_id});
            ...
            function get_det(stud_id, month_no, month_desc, status, year, e)
            {
                ...
                {
                    fee_cat_id = 2;
                    $('#monthly_pay1').load('<?php echo base_url('Payment_Previous/btn_download_pop_load'); ?>', {stud_id: stud_id, month_no: month_no, month_desc: month_desc, year: year, fee_cat: fee_cat_id, sem_name: sem});
                    $("#transaction_det1").modal('show');
                } else if (status == 'year')
                {
                    fee_cat_id = 1;
                    $('#monthly_pay1').load('<?php echo base_url('Payment_Previous/btn_download_pop_load'); ?>', {stud_id: stud_id, month_no: 0, month_desc: month_desc, year: year, fee_cat: fee_cat_id, sem_name: sem});
                    $("#transaction_det1").modal('show');
                } else if (status == 'half')
                {
                    fee_cat_id = 4;
...
$.ajax({
    url: '<?php echo base_url('Payment_Previous/get_student_fee'); ?>',
    dataType: "text",
    method: 'POST',
