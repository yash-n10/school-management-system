                                                        ...
                                                        <div id="1" class="row">    
                                                            <?php if (1 >= $student[0]->start_fee_month) { ?>
                                                                <label  class="checkbox-inline  col-xs-1" > 
                                                                    ...
                                                                    ?>  name="month[]" value="1" data-qtr="<?php echo $qtrs['1']; ?>"><i class="helper" id="apr"></i>Apr</label>     
                                                                ...
                                                                <label class="checkbox-inline col-xs-1"><input class="" type="checkbox" autocomplete="off" <?php
                                                                    ...
                                                                    ?> name="month[]" value="2" data-qtr="<?php echo $qtrs['2']; ?>" id="may">May</label>
                                                                ...
                                                                <label class="checkbox-inline col-xs-1"><input type="checkbox" autocomplete="off" <?php
                                                                    ...
                                                                    ?> name="month[]" value="3" data-qtr="<?php echo $qtrs['3']; ?>" id="jun">Jun</label>
                                                                ...
                                                                <label class="checkbox-inline col-xs-1" ><input type="checkbox" autocomplete="off" <?php
                                                                    ...
                                                                    ?> name="month[]" value="4" data-qtr="<?php echo $qtrs['4']; ?>" id="jul">Jul</label>
                                                                <?php } ?>
                                                        </div>
                                                        <div class="row">
                                                            <?php if (5 >= $student[0]->start_fee_month) { ?>
                                                                <label class="checkbox-inline col-xs-1"><input type="checkbox" autocomplete="off" <?php
                                                                    ...
                                                                    ?> name="month[]" value="5" data-qtr="<?php echo $qtrs['5']; ?>" id="aug">Aug</label>
                                                                ...
                                                                <label class="checkbox-inline col-xs-1" ><input type="checkbox" autocomplete="off" <?php
                                                                    ...
                                                                    ?> name="month[]" value="6" data-qtr="<?php echo $qtrs['6']; ?>" id="sept">Sep</label>
                                                                ...
                                                                <label  class="checkbox-inline col-xs-1"><input type="checkbox" autocomplete="off" <?php
                                                                    ...
                                                                    ?> name="month[]" value="7" data-qtr="<?php echo $qtrs['7']; ?>"  id="oct">Oct</label>
                                    ...
                                    // alert('False');
                                        // document.getElementById("submit").setAttribute("disabled", "disabled");
                                                                ...
                                                                <label class="checkbox-inline col-xs-1 col-md-1" ><input type="checkbox" autocomplete="off"  <?php
                                                                    ...
                                                                    ?> name="month[]" value="10" data-qtr="<?php echo $qtrs['10']; ?>" id='jan'>Jan</label>
                                                                ...
                                                                <label class="checkbox-inline col-xs-1 col-md-1" ><input type="checkbox" autocomplete="off"  <?php
                                                                    ...
                                                                    ?> name="month[]" value="11" data-qtr="<?php echo $qtrs['11']; ?>" id='feb' >Feb</label>
                                                                ...
                                                                <label class="checkbox-inline col-xs-1 col-md-1" ><input type="checkbox" autocomplete="off" <?php
                                                                    ...
                                                                    ?> name="month[]" value="12" data-qtr="<?php echo $qtrs['12']; ?>" id='mar'>Mar</label>
                                                                <?php } ?>
                                                        </div>
                                                    </div>
                                                </div>
...
//                                            $total = $total + $transport_fee_amt * $count;
                                        ...
                                        if ($fine_apply_status == 1 && $fine_amount != 0) 
                                        {
                                            ...
                                            <tr>                 
                                                ...
                                                <td ><input type="text" readonly="true" style="border: 0px;width: 100%;background:inherit" name="fine_amt"  value="<?php echo $fine_amount; ?>" id="fine_amt"></td>
                                        ...
                                        if (count($annual_fee_paid->result()) == 0 && $school[0]->annual_month != 0 && ($bm - 3) >= $school[0]->annual_month) {
                                            ...
                                            if ($total_annual_f != 0) {
                                                ...
                                                if ($start_fee_month != 1) {
                                                    ...
                                                    $total_annual_f=round($total_annual_f) ;
                                                    // print_r($total_annual_f);die();
                                                }
