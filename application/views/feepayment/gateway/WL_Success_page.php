    ...
    <center>
       ...
       <?php if($ERROR!=NULL || $ERROR!='') { ?>
            ...
            <div class="alert alert-danger" style="background:red;color: white;border-bottom:1px solid grey;">
                <i class="fa fa-lg fa-exclamation-triangle" style="font-size:3.333333em;" aria-hidden="true"></i> <strong style="font-size:2.333333em;"><?php echo $ERROR;?></strong>  
            </div>
       ...
       <?php } else { 
                    ...
                    if($statusCode=='S'){?>
                        <div class="alert alert-success" style="border-bottom:1px solid grey;">
                             <i class="fa fa-lg fa-check-circle" style="font-size:3.333333em;" aria-hidden="true"></i> <strong style="font-size:2.333333em;">Transaction Successful</strong>  
                         </div>
                            <?php } else { ?>
                             <div class="alert alert-danger" style="background:red;color: white;border-bottom:1px solid grey;">
                                 <i class="fa fa-lg  fa-exclamation-triangle" style="font-size:3.333333em;" aria-hidden="true"></i> <strong style="font-size:2.333333em;">Transaction Failure</strong>  
                             </div>
                             <?php } ?>
                        ...
                        <tr><!-- PG transaction reference number-->
                                <th><label for="txnRefNo">Transaction Ref No</label></th>
                                <td>:<?php echo $txnRefNo;?></td>                                
                        </tr>
            
                        <tr>
                           <th><label for="orderId">Order No.</label></th>
                           <td>:<?php echo $orderId;?></td> 
                        </tr>
                        <tr> 
                              <th><label for="amount">Amount Paid to School</label></th>
                              <td>:<?php echo $amount/100 .' INR';?></td>
                        </tr>
                        ...
                        <tr>
                            <td colspan="2" style="text-align: center;font-weight:bolder;color: red">NOTE :  Please Dont't Go Back OR Refresh It</td> 
                        </tr>
                        <tr>
                            <!-- <td colspan="2" style="text-align: center;"><?php require_once(APPPATH . "includes/copyright.php"); ?></td> -->
