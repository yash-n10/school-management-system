<style type="text/css">  
	...
	.with-border {
			background: #00c6f7;	/*background: #ff8080;*/
			color:white;
	...
	<?php// echo $student_class_id; ?>
		...
		<?php } ?>
			...
			<div class="panel  panel-danger">
				...
				<div class="panel-heading" style="padding:5px 15px; color:white; background-color:#00c6f7; border-color:#fc9797;" style="font-weight:bold; font-size:18px">
						<i class="fa fa-inr"></i><b><span style="">&nbsp;Pay Fees</span></b>
				</div>
				...
				<!----------DAVB---Transpoert Fee Remove/ Active One month/ Fine Remove-------->
					...
					<?php if($school[0]->id==29 or $school[0]->id==25 or $school[0]->id==5){ ?>
						<div class="col-md-5">
								...
								<div class="box-body">
									...
									<table id="paymentlist" class="table table-bordered table-striped">
										<thead style="background-color: #fff!important;color: #000;">
														...
														<div class="col-xs-12 col-md-12" style="padding-right: 11px; padding-left:11px;">
															<div id="1" class="row">                                   
																<label  class="checkbox-inline  col-xs-1" > 
																	<input type="checkbox"  <?php
																		...
																		?>  name="month[]" value="1" <?php if (($school[0]->id==29)) echo $checkedblock_status[1];?> <?php if(($school[0]->id==5) || ($school[0]->id==35)) echo $checkedblock_status[1];?>>
																		<i class="helper"></i>Apr
																</label>                      
																...
																<label class="checkbox-inline col-xs-1"><input class="" type="checkbox" autocomplete="off" <?php
																		...
																		?> name="month[]" value="2" <?php if(($school[0]->id==5) || ($school[0]->id==35)) echo $checkedblock_status[2];?>>May
																</label>
																...
																<label class="checkbox-inline col-xs-1"><input type="checkbox" autocomplete="off" <?php
																		...
																		?> name="month[]" value="3" <?php if(($school[0]->id==5) || ($school[0]->id==35)) echo $checkedblock_status[3];?> >Jun
																</label>
																...
																<label class="checkbox-inline col-xs-1" ><input type="checkbox" autocomplete="off" <?php
																		...
																		?> name="month[]" value="4" <?php if(($school[0]->id==5) || ($school[0]->id==35)) echo $checkedblock_status[4];?> >Jul  
																</label>
															</div>
															...
															<div class="row">
																<label class="checkbox-inline col-xs-1"><input type="checkbox" autocomplete="off" <?php
																		...
																		?> name="month[]" value="5" <?php if(($school[0]->id==5) || ($school[0]->id==35)) echo $checkedblock_status[5];?>>Aug
																</label>
																<label class="checkbox-inline col-xs-1"><input type="checkbox" autocomplete="off" <?php
																		...
																		?> name="month[]" value="6" <?php if(($school[0]->id==5) || ($school[0]->id==35)) echo $checkedblock_status[6];?>>Sep 
																</label>
																<label class="checkbox-inline col-xs-1"><input type="checkbox" autocomplete="off" <?php
																		...
																		?> name="month[]" value="7" <?php if(($school[0]->id==5) || ($school[0]->id==35)) echo $checkedblock_status[7];?> >Oct
																		</label>
															...
															<div id="2" class="row">    
																...
																<label class="checkbox-inline col-xs-1 col-md-1"><input type="checkbox" autocomplete="off"  <?php
																		...
																		?> name="month[]" value="9" <?php if(($school[0]->id==5) || ($school[0]->id==35)) echo $checkedblock_status[9];?>>Dec 
																</label>
																<label class="checkbox-inline col-xs-1 col-md-1"><input type="checkbox" autocomplete="off"  <?php
																		...
																		?> name="month[]" value="10" <?php if(($school[0]->id==5) || ($school[0]->id==35)) echo $checkedblock_status[10];?>>Jan 
																</label>
																<label class="checkbox-inline col-xs-1 col-md-1"><input type="checkbox" autocomplete="off"  <?php
																		...
																		?> name="month[]" value="11" <?php if(($school[0]->id==5) || ($school[0]->id==35)) echo $checkedblock_status[11];?> >Feb 
																</label>
																<label class="checkbox-inline col-xs-1 col-md-1"><input type="checkbox" autocomplete="off" <?php
																		...
																		?> name="month[]" value="12" <?php if(($school[0]->id==5) || ($school[0]->id==35)) echo $checkedblock_status[12];?>
											...
											<tr>                 
												<th class="hdr">Fee Name</th>
												<th class="hdr">Amount</th>     
											</tr>
										</thead>
                                        
										<tbody id="get_month_fee_det" class="get_month_fee_det">                   
											<?php
											$total = 0;
											$total1 = 0;
											// $a = $student_class_id ;
											...
											<tr>                 
												<td style="white-space: nowrap" class="label_fee"><?php echo $row->fee_name; ?></td>
												<td style="white-space: nowrap" class="label_fee_amount" ><?php echo $row->fee_amount * $count; ?> </td>              
											</tr>
											<?php } ?>  
                                            ...
                                            if ($disable_trans == 1) {
                                                ...
                                                if ($school[0]->stop_transaction == 'NO' && $chequefreezeqry[0]->id==0) {
                                                    ...
                                                    <button class="btn btn-app" id="total" name="total" type="button" style="padding: 0px;">
                                                        ...
                                                        <span class="span" id="tot_val">INR <?php echo $total; ?></span>
                                                    </button> 
                                                    <?php
                            ...
                            <div class="box-body">
                                ...
                                <table id="paymentlist" class="table table-bordered table-striped">
                                    ...
                                    if ($fine_apply_status == 1 && $fine_amount != 0) {
                                        ...
                                        ?> 
                                <!-- HERE VV HALF YEARLY FEE IS DEFINED YASH -->
							...
							<table id="other_fee" class="table table-bordered table-striped" style="width:100%">
                              ...
                              <!--      <h3 class="box-title" id="msege_book" style="display: none;text-align:center;font-weight:bold;font-size: 16px">This book is out Stock</h3> -->
									<tr>  
										...
										<th class="hdr" style="width:55%">Fee Name</th>
										<th class="hdr" style="width:30%">Fee Amount</th>     
									</tr>
								</thead> 
								...
								<tbody>
										...
										<?php if($othhfeeid==$obj_fee->fee_id){ ?>
											...
											$school_session_id = $this->session->userdata('school_id');
												if($school_session_id==29)
												{
													...
													//COMMENTED BY YASH TO SWITCH ON BOOK PAYMENT


													// if ($obj_fee->fee_id ==10) {
									...
									// echo "<br>";echo($value);
														...
														//}
														// if ($count >5){
														// echo 'BOARD/Registration FEES IS CLOSED';
									// 					?>	<!-- 
					 							...
					 							<td><?php echo $obj_fee->fee_name; ?></td>
													...
													// 	}
													// 	else {
													// 		echo "BOARD / REGISTRATION FEE WILL BE OPENED AFTER PAYMENT OF MONTHLY FEES TILL SEPTEMBER";
													// 	}
													// }
													// elseif ($obj_fee->fee_id ==11) {
													// 	echo "BOARD FEES IS CLOSED";
													// }
             //                   						elseif ($obj_fee->fee_id=138 or $obj_fee->fee_id=139 or $obj_fee->fee_id=140 or $obj_fee->fee_id=141) {
             //                   						}
													// else {
														?>
...
<?php //if($school[0]->school_group !='DAV') { ?>
    <div class="col-md-7">
        <div class="box" style="border: 1px solid darkgrey;">
            <form class="form-horizontal" method="POST" role="form" id="instant_paym" action="<?php echo base_url("payment/request") ?>">
                <div class="box-header with-border" style="">
...
<!-- YASH CODING ADDING OLYMPIAD FEES START-->
 <!-- <?php  if(($this->session->userdata('school_id')==29)){ ?>
    <div class="col-md-7">
        <div class="box" style="border: 1px solid darkgrey;">
            <form class="form-horizontal" method="POST" role="form" id="olympiadfee1" action="<?php echo base_url("payment/request") ?>">
                <div class="box-header with-border" style="">
...
<div class="box">
    <div class="box-body" >
		...
		<div class="panel-heading" style="padding: 5px 15px;background-color: #c7eab9"><i class="glyphicon glyphicon-time"></i>
			<b><span style="color:black">&nbsp;Transaction History</span></b>
		</div>
		...
		<div class="panel-body" style="padding:0px">
			<div class="table-responsive">
						...
						<tbody>
							...
							<?php if(($this->id==29 && $payment->id==83028) ||($this->id==29 && $payment->id==83031) || ($this->id==29 && $payment->id==82409) || ($this->id==29 && $payment->id==83175) || ($this->id==29 && $payment->id==83173)|| ($this->id==29 && $payment->id==109956) || ($this->id==29 && $payment->id==109957) ||($this->id==29 && $payment->id==110603)||($this->id==29 && $payment->id==110606)||($this->id==29 && $payment->id==110620)) { ?>
								<tr>
									...
									<td><?php echo $str; ?></td>
									<td class="amt"><?php echo 'INR ' . $payment->total_amount; ?></td>
									...
									<?php  if(($payment->book_status=='PENDING')&& ($payment->fee_cat_id=='3')){ ?>
										...
										<?php } else { ?>
												...
												<?php } ?>
													<td><?php echo date('Y-m-d', strtotime($payment->payment_date)); ?></td>
													<td><?php echo $str; ?></td>
													<td><?php echo 'INR ' . $payment->total_amount; ?></td>
													<td><?php echo $payment->remarks . ' (' . $payment->response_message . ')'; ?></td>
													<td><?php echo $payment->receipt_no; ?></td>
													<td><?php echo $payment->payment_id; ?></td>
                ...
                <div class="modal-footer">
                    <b>TOTAL PAID AMOUNT : INR <?php echo $total_paid; ?></b>
                </div>
            </div>
        </div>
    </div>
...
//COMMENTED BY YASH TO REMOVE @ MONTHS CHECKED IN VIVEK VIDYALAYA
