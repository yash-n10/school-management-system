...
<div class="form-group has-feedback">
    <div class="panel  panel-default" style="background: floralwhite;"> 
        ...
        <form id='frmaddsection' action="<?php // echo base_url('fee/save_class_fee') ?>" role="form" method="POST">
            ...
            <?php } ?>
            <div class="box-body" style="<?php echo $style1; ?>">
                <?php $yval=strlen($year); ?>
                <?php if(($task=='edit') && ($yval>=4)) { ?>
                <div class="row" style="margin-bottom:30px;">                                      
                            <div class="col-md-2" style="padding:0px;text-align:right;width: 15.667% !important;"> <b> Year (now onwards): </b> </div>
                            <div class="col-md-2" style="width: 15.667% !important;"><input type="number" maxlength="4" min="1999" max="2999" id="year" required="" value="<?php if($task=='edit'){echo $year;} ?>" step="0" name="year" class="form-control" placeholder="year"></div>
                 ...
                 <?php } else { ?>
                <div class="row" style="margin-bottom:30px;">                                      
                            <div class="col-md-2" style="padding:0px;text-align:right;width: 15.667% !important;"> <b> Session (now onwards): </b> </div>
                            <div class="col-md-2" style="width: 15.667% !important;">
                                 <select name="year" class="form-control" id="year" required>
                                    <option value="">Select Session</option>
                                    <?php foreach ($select_session as $ses) {
                                        ?>
                                        <option <?php if($task=='edit'){if($year==$ses->id){echo 'selected="selected"';}} ?> value="<?php echo $ses->id; ?>"><?php echo $ses->session; ?></option>
                                    <?php } ?>
                                </select>
                            </div>
            ...
            <?php } ?>
                ...
                <div class="row" style="margin-bottom:30px;">
                    ...
                    <div class="col-md-2" style="text-align:right;padding:0px;width: 15.667% !important;"> <b> Class-range :</b></div>
                    <div class="col-md-2" style="width: 15.667% !important;">                       
                    ...
                    <div class="col-md-2" style="padding:0px;width: 15.667% !important;"> <b>Especially For class(11-12)</b> </div>
...
//                       if($year>$session_start_yr || ($year==$session_start_yr && $session_start_month==date('m'))  || $this->session->userdata('school_id')==29){
                       // if($year>$session_start_yr || ($year==$session_start_yr && $session_start_month==date('m')) || ($this->session->userdata('school_id')==8)|| ($this->session->userdata('school_id')==29) ||($this->session->userdata('school_id')==25) ||($this->session->userdata('school_id')==5)){
if($this->session->userdata('school_id')==25 or $this->session->userdata('school_id')==29){
                       	?>
