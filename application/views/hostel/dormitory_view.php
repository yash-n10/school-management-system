...
<div class="form-group has-feedback">
    <div class="box">            
        ...
        <div class="box-body">
            <div class="col-lg-12">
                <div class="col-lg-12" style="text-align:right;"><button data-toggle="modal" data-target="#div_add_dormitory" class="btn btn-add" id="add_dorm" title="Add Dormitory"> <i class="fa fa-plus-circle fa-lg"></i> </button></div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-2">
                                            <a class="btn a-edit" id="<?php echo $row->id; ?>" onclick="edit(this,<?php echo $row->dorm_type_id; ?>)">
