...
<!--        <div class="box-header">
        ...
        <div class="box-body">
            ...
            <div class="col-lg-12">
                <div class="col-lg-12" style="text-align:right;"><button data-toggle="modal" data-target="#div_dormitory_type" class="btn btn-add" id="dorm_type" title="Add Dormitory Type"> <i class="fa fa-plus-circle fa-lg"></i></button></div>
            </div>
            <?php //}?>
        </div>
