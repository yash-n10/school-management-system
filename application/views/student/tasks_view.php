	...
	<div class="box-content padded">
		...
		<div class="tab-content">
            	...
            	<div class="pull-right custom-tam-table-btns">
                    	...
                    	<a href="<?php echo base_url() ?>student/taskadd" class="btn btn-small btn-lightblue"><?php echo get_phrase('add_new_task');?></a>
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="dTable responsive">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="center"><a href="<?php echo base_url() ?>student/taskedit/<?php echo $tasks_data_view->task_id ?>" class="btn btn-small btn-lightblue"><i class="icon-wrench"></i> Edit</a>
                            
                            <a  data-toggle="modal" href="#modal-delete" onclick="modal_delete('<?php echo base_url(); ?>student/taskdelete/<?php echo $tasks_data_view->task_id ; ?>')" class="btn btn-red btn-small">
