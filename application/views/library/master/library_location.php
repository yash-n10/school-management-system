					...
					<div class="col-md-12">
						<div class="col-md-4">
							<div class="form-group">
							    <label for="inputPassword" class="col-sm-4 col-form-label">Library Name</label>
							    <div class="col-sm-8">
							      <input type="text" class="form-control" id="library_name" value="" placeholder="Library Name" >
...
<script type="text/javascript">
	...
	function save()
	{
		...
		$.ajax({
            url : "<?php echo base_url('library/master/book_loc/save');?>",
            type: "POST",
	...
	function deletes(id)
	{
		...
		if (r == true) {
			...
			$.ajax({
	            url: "<?php echo base_url('library/master/book_loc/delete'); ?>",
	            type: "POST",
	            data: {id:id},
	            success: function (data)
	            {
	...
	function update(id)
	{
     ...
     $('#butt1').show();
     $.ajax({
            url: "<?php echo base_url('library/master/book_loc/update'); ?>",
            type: "POST",
            data: {id:id},
            dataType:"json",
            success: function (data)
	...
	function update_data()
	{
		...
		var hid = $('#hid').val();
	    $.ajax({
            url: "<?php echo base_url('library/master/book_loc/update_data'); ?>",
            type: "POST",
            data: {library_name:library_name,hid:hid},
            success: function (data)
            {
