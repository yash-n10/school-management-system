		...
		<div class="box-body">
			<div class="col-lg-12">
				...
				<div class="col-lg-6" style="text-align:right;">
					<a class="btn btn-success" href="<?php echo base_url('library/books/download_format'); ?>" download="">
                        ...
                        <div class="table-responsive " style="padding-top:8px">
                         <table class="table table-striped table-bordered ">
                            ...
                            <tr class="success">
                                ...
                                <th>Book Code/Acc No.<span style="color:red">(REQUIRED in UPLOAD and BULK UPDATE)</span></th>
                                <th>Book Name <span style="color:red;font-size:11px">REQUIRED in UPLOAD and BULK UPDATE</span></th>
                                <th>Subtitle</th>
                                <th>Edition </th>
                                <th>Quantity</th>
                                <th>Year Published</th>
                                <th>Author<span style="color:red;font-size:11px">(REQUIRED IN UPLOAD ONLY)</span></th>
                                <th>Publisher</th>
                                <th>Binding Type</th>
                                <th>Cost</th>
                                <th>Description</th>
                                ...
                                <!--<th>normal Loc</th>
                                <th>Current Loc</th>
                                <th>Cuurent Loaned To</th>
                                <th>Return Deadline</th>-->
                                
                            </tr>                   
                            <tr class="warning">
                                <td>Book Code/Acc No. REQUIRED</td>
                                <td>Book Name</td>
                                <td>Book Subtitle</td>
                                <td>Book Edition</td>
                                ...
                                <td>Define binding type</td>
                                <td>Cost/Price of book</td>
                                <td>Description of book</td>
                                <td><?php $str2='';$s2=1;foreach($fetch_class as $ac){$str2.=$s2.'.)  '.$ac->class_name.' <html><br></html>';$s2++;} rtrim($str2); echo $str2;?> (choose one option)</td>
                                <td></td>
                                <td>ISBN Number of book</td>
                                <td>Source/vendor</td>
                                <td>Date of Entry</td>
                                <td>Total number of pages in book</td>
