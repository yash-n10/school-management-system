	...
	<ul class="nav nav-collapse collapse nav-collapse-primary">
		...
		<li class="<?php if($page_name == 'dashboard')echo 'dark-nav active';?>">
			...
			<span class="glow"></span>
				...
				<a href="<?php echo base_url();?>teacher/dashboard" rel="tooltip" data-placement="right" 
		...
		<li class="<?php if($page_name == 'student')echo 'dark-nav active';?>">
			...
			<span class="glow"></span>
				...
				<a href="<?php echo base_url();?>teacher/student" rel="tooltip" data-placement="right" 
		...
		<li class="<?php if($page_name == 'teacher')echo 'dark-nav active';?>">
			...
			<span class="glow"></span>
				...
				<a href="<?php echo base_url();?>teacher/teacher_list" rel="tooltip" data-placement="right" 
		...
		<li class="<?php if($page_name == 'subject')echo 'dark-nav active';?>">
			...
			<span class="glow"></span>
				...
				<a href="<?php echo base_url();?>teacher/subject" rel="tooltip" data-placement="right" 
		...
		<li class="<?php if($page_name == 'marks')echo 'dark-nav active';?>">
			...
			<span class="glow"></span>
				...
				<a href="<?php echo base_url();?>teacher/marks" rel="tooltip" data-placement="right" 
		...
		<li class="<?php if($page_name == 'attendence')echo 'dark-nav active';?>">
			...
			<span class="glow"></span>
				...
				<a href="<?php echo base_url();?>teacher/attendence" rel="tooltip" data-placement="right" 
		...
		<li class="<?php if($page_name == 'class_routine')echo 'dark-nav active';?>">
			...
			<span class="glow"></span>
				...
				<a href="<?php echo base_url();?>teacher/class_routine" rel="tooltip" data-placement="right" 
		...
		<li class="<?php if($page_name == 'book')echo 'dark-nav active';?>">
			...
			<span class="glow"></span>
				...
				<a href="<?php echo base_url();?>teacher/book" rel="tooltip" data-placement="right" 
		...
		<li class="<?php if($page_name == 'transport')echo 'dark-nav active';?>">
			...
			<span class="glow"></span>
				...
				<a href="<?php echo base_url();?>teacher/transport" rel="tooltip" data-placement="right" 
		...
		<li class="<?php if($page_name == 'noticeboard')echo 'dark-nav active';?>">
			...
			<span class="glow"></span>
				...
				<a href="<?php echo base_url();?>teacher/noticeboard" rel="tooltip" data-placement="right" 
		...
		<li class="<?php if($page_name == 'backup_restore')echo 'dark-nav active';?>">
			...
			<span class="glow"></span>
				...
				<a href="<?php echo base_url();?>teacher/backup_restore" rel="tooltip" data-placement="right" 
		...
		<li class="<?php if($page_name == 'manage_profile')echo 'dark-nav active';?>">
			...
			<span class="glow"></span>
				...
				<a href="<?php echo base_url();?>teacher/manage_profile" rel="tooltip" data-placement="right" 
