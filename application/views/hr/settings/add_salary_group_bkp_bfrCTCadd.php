                        ...
                        <fieldset class="">
                                        ...
                                        <table class="table table-bordered">
                                            ...
                                            foreach ($fetch_salary_name as $sal) {
                                                if ($sal->salary_typ == 1) {
                                                    ...
                                                    <td class="col-md-6" style="padding:8px;"> <input type="number" step="0.0001" min="0" required id="earning_<?php echo $sal->id; ?>" name="sal_amount[]" value="<?php
                                                        if ($task == 'Update') {
                                                            echo $sal->sal_amt;
                                                        } else {
                                                            echo '';
                                            ...
                                            <tr style="background-color:#f5f5f5;"> 
                                                ...
                                                <td  style="padding:8px;"> 
                                                    <input type="number" step="0.0001" min="0" readonly name="total_sal" id="total_sal" value="<?php
                                                           if ($task == 'Update') {
                                                               echo $tot;
                                                           }
                                                           ?>"></td> </tr>
                                        ...
                                        <table class="table table-bordered">
                                            ...
                                            foreach ($fetch_salary_name as $sal) {
                                                if ($sal->salary_typ == 2 ) {
                                                    ...
                                                    <td class="col-md-6"> <?php echo $sal->salary_name.' ' .$title; ?> </td>
                                                    <td class="col-md-6">
                                                        <input  type="number" step="0.0001"  min="0"  id="deduction_<?php echo $sal->id; ?>" name="sal_amount[]" value="<?php
                                                        if ($task == 'Update') {
                                                            echo $sal->sal_amt;
                                                        } else {
                                                            echo '';
                                                    ...
                                                    ?>
                                            <tr style="background-color:#f5f5f5;"> <td > Total Deduction </td> <td  style="padding:8px;"> <input type="number" min="0"  step="0.0001" readonly name="total_deduc_sal" id="total_deduc_sal" value="<?php
                                                    if ($task == 'Update') {
                                                        echo $total1;
                                                    }
                                                    ?>"></td> </tr>
                           ...
                           <!--  <div class="row">
                                        ...
                                        <th> Amount </th>
                                            ...
                                            foreach ($fetch_salary_name as $sal) {
                                                if ($sal->salary_typ == 4 ) {
                                                    ...
                                                    <td class="col-md-6"> <?php echo $sal->salary_name.' ' .$title; ?> </td>
                                                    <td class="col-md-6">
                                                        <input  type="number" step="0.0001"  min="0"  id="ctchead_<?php echo $sal->id; ?>" name="sal_amount[]" value="<?php
                                                        if ($task == 'Update') {
                                                            echo $sal->sal_amt;
                                                        } else {
                                                            echo '';
                                                    ...
                                                    ?>
                                            <tr style="background-color:#f5f5f5;"> <td > Total CTC HEAD AMT </td> <td  style="padding:8px;"> <input type="number" min="0"  step="0.0001" readonly name="total_ctc_sal" id="total_ctc_sal" value="<?php
                                                    if ($task == 'Update') {
                                                        echo $total1;
                                                    }
                                                    ?>"></td> </tr>
                            ...
                            <div class="col-md-12" style="text-align:center; border:1px solid gray; padding:10px; background-color:#fce4ec ;">
                                <div class="col-md-6">    <label for="" style="padding-right: 20px;"> Net Payable Salary </label> <input type="number" min="0" step="0.0001" readonly name="net" id="net" value="<?php echo $payable; ?>">  </div>
                                <div class="col-md-6">    <label for="" style="padding-right: 20px;"> Gross Salary </label> <input type="number" min="0" step="0.0001" readonly name="gross" id="gross" value="<?php echo $gross_pay; ?>"> </div>
                            </div>
                                ...
                                <table class="table table-bordered table-striped" style="border:1px solid grey !important;">
                                    ...
                                    <tr style="">
                                        ...
                                        <td style="padding-left:30px;" class="col-md-8">
                                            <input  type="number" step="0.0001"  min="0"  id="ededuction_<?php echo $sal->id; ?>" name="sal_amount[]" value="<?php
                                                        if ($task == 'Update') {
                                                            echo $sal->sal_amt;
                                                        } else {
                                                            echo '';
                                    ...
                                    <tr style="background-color:#fffde7;">
                                        ...
                                        <td style="padding-left:30px;">  <input type="number"  step="0.0001"  required style="pointer-events: none" name="ctc_mnth" id="ctc_mnth" value="<?php echo $ctc_mon; ?>"> </td>
                                    </tr>
                                    <tr style="background-color:#fffde7;">
                                        <td style="padding-left:30px; font-weight:600;"> CTC Per Year </td>
                                        <td style="padding-left:30px;">  <input type="number"  step="0.0001" required style="pointer-events: none" name="ctc_yr" id="ctc_yr" value="<?php echo $ctc_ann; ?>"> </td>
                                    </tr>
...
//                                                alert($('#add_stud_frm')[0].validationMessage);
        ...
        //   $('#salary_calc input[type=number],' + '#sal_calc input[type=number],' + '#sal_calc_ctc input[type=number]').change(function ()
        // {
        ...
        function calc_gross()
        {
            ...
            // $('#ctc_mnth').val(gross1+total1+uniform);    // CTC/month = Gross Salary + Employer Contribution Salary 
