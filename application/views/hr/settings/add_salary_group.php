                ...
                <div class="row" style="padding-top:2%">
                    <div class="col-sm-12">
                        <fieldset class="">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <label for="" style="padding-right: 20px;">  Fixed Pay  </label> <input type="number" min="0" step="0.1" name="basic_enter" id="basic_enter" value="<?php echo $gross_pay; ?>">
                                </div>
                                        ...
                                        <table class="table table-bordered">
                                                ...
                                                if ($sal->salary_typ == 1) 
                                                {
                                                    ...
                                                    <tr id="salary_calc">
                                                        ...
                                                        <td class="col-md-6" style="padding:8px;"> 
                                                            <input type="number" step="0.1" min="0" required class="earning_<?php echo $sal_code;?>" id="earning_<?php echo $sal->id; ?>" name="sal_amount[]" value="<?php if ($task == 'Update') {echo $sal->sal_amt;} else {echo '';}?>">
                                                        </td>
                                                    </tr>
                                                <?php
                                                }
                                            ...
                                            <tr style="background-color:#f5f5f5;"> 
                                                ...
                                                <td  style="padding:8px;"> 
                                                    <input type="number" step="0.1" min="0" readonly name="total_sal" id="total_sal" value="<?php if ($task == 'Update') {echo $tot;}?>">
                                                </td> 
                                            </tr>
                                        </table>
                                    </div>
                                        ...
                                        <table class="table table-bordered">
                                            ...
                                            foreach ($fetch_salary_name as $sal) 
                                            {
                                                ...
                                                if ($sal->salary_typ == 2 ) 
                                                {
                                                    ...
                                                    <td class="col-md-6"> <?php echo $sal->salary_name.' ' .$title; ?> </td>
                                                    <td class="col-md-6">
                                                        <input  type="number" step="0.1"  min="0" class="deduction_<?php echo $cod;?>" id="deduction_<?php echo $sal->id; ?>" name="sal_amount[]" value="<?php if ($task == 'Update') {echo $sal->sal_amt;} else {echo '';}?>" required>
                                                    </td> 
                                                    </tr>
                                                    <?php
                                                }
                                            ...
                                            ?>
                                            <tr style="background-color:#f5f5f5;"> <td > Total Deduction </td> <td  style="padding:8px;"> <input type="number" min="0"  step="0.1" readonly name="total_deduc_sal" id="total_deduc_sal" value="<?php
                                                    if ($task == 'Update') {
                                                        echo $total1;
                                                    }
                                                    ?>"></td> </tr>
                                        ...
                                        <th> Amount </th>
                                            ...
                                            foreach ($fetch_salary_name as $sal) 
                                            {
                                                if ($sal->salary_typ == 4 ) 
                                                {
                                                    ...
                                                    <td class="col-md-6"> <?php echo $sal->salary_name.' ' .$title; ?> </td>
                                                    <td class="col-md-6">
                                                        <input  type="number" step="0.1"  min="0" class="ctchead_<?php echo $sal->salary_code;?>" id="ctchead_<?php echo $sal->id; ?>" name="sal_amount[]" value="<?php
                                                        if ($task == 'Update') {
                                                            echo $sal->sal_amt;
                                                        } else {
                                                            echo '';
                                            ...
                                            ?>
                                            <tr style="background-color:#f5f5f5;"> <td > Total CTC HEAD AMT </td> <td  style="padding:8px;"> <input type="number" min="0"  step="0.1" readonly name="total_ctc_sal" id="total_ctc_sal" value="<?php
                                                    if ($task == 'Update') {
                                                        echo $total2;
                                                    }
                                                    ?>"></td> </tr>
                            ...
                            <div class="col-md-12" style="text-align:center; border:1px solid gray; padding:10px; background-color:#fce4ec ;">
                                <div class="col-md-6">    <label for="" style="padding-right: 20px;"> Net Payable Salary </label> <input type="number" min="0" step="0.1" readonly name="net" id="net" value="<?php echo $payable; ?>">  </div>
                                <div class="col-md-6">    <label for="" style="padding-right: 20px;"> Gross Salary </label> <input type="number" min="0" step="0.1" readonly name="gross" id="gross" value="<?php echo $gross_pay; ?>"> </div>
                            </div>
                            ...
                            <div class="" style="margin-top:70px;">
                                <table class="table table-bordered table-striped" style="border:1px solid grey !important;">
                                    ...
                                    <tr style="">
                                        ...
                                        <td style="padding-left:30px;" class="col-md-8" id="empyrdedc">
                                            <input  type="number" step="0.1"  min="0"  id="ededuction_<?php echo $sal->id; ?>" name="sal_amount[]" value="<?php
                                                        if ($task == 'Update') {
                                                            echo $sal->sal_amt;
                                                        } else {
                                                            echo '';
                                    ...
                                    <tr style="background-color:#fffde7;">
                                        ...
                                        <td style="padding-left:30px;">  <input type="number"  step="0.1"  required style="pointer-events: none" name="ctc_mnth" id="ctc_mnth" value="<?php echo $ctc_mon; ?>"> </td>
                                    </tr>
                                    <tr style="background-color:#fffde7;">
                                        <td style="padding-left:30px; font-weight:600;"> CTC Per Year </td>
                                        <td style="padding-left:30px;">  <input type="number"  step="0.1" required style="pointer-events: none" name="ctc_yr" id="ctc_yr" value="<?php echo $ctc_ann; ?>"> </td>
                                    </tr>
...
<script>
    $('.earning_DA').on('change', function() {
        var da = $(this).val();
        var ba = $('.earning_BASIC').val();
        var percent_amt = 12;
        var pf_emp = (percent_amt*(parseInt(da)+parseInt(ba)))/100;
        $('.deduction_EPF').val('');
        $('.deduction_EPF').val(Math.round(pf_emp));

        var lctc = (((parseInt(da)+parseInt(ba))/30)*14)/12;        
        $('.ctchead_LCTC').val('');
        $('.ctchead_LCTC').val(Math.round(lctc));

        var gratuity = (((parseInt(da)+parseInt(ba))/26)*15)/12;        
        $('.ctchead_Gratuity').val('');
        $('.ctchead_Gratuity').val(Math.round(gratuity));
    ...
    $(document).ready(function () {
        ...
        $('#gross_enter').change(function(){
            ...
            $("input[name^='sal_id']").each(function(){
                ...
                switch(wagetype) {
                    ...
                    case 'GROSS' : 
                       ...
                       $(this).closest('tr').find('input[name^="sal_amount"]').val(Math.round(amt));
                       break;
                    case 'BA+DA' :    
            ...
            var total = 0;
                ...
                $('#total_sal').val(Math.round(toten));
                ...
                $('#total_deduc_sal').val(Math.round(tot));

                 var total2 = 0;
                $("input[id^='ctchead']").each(function ()
                {
                    total2 += Number(this.value);

                });
                var tot2 = total2.toFixed();
                $('#total_ctc_sal').val(Math.round(tot2));
            calc_gross();
...
//                                                alert($('#add_stud_frm')[0].validationMessage);
        ...
        $('#sal_calc_ctc input[type=number]').change(function () {
            var total2 = 0;
            $("input[id^='ctchead']").each(function ()
            {
        ...
        $('#salary_calc input[type=number],' + '#sal_calc input[type=number],' + '#sal_calc_ctc input[type=number],' +'#empyrdedc input[type=number]').change(function ()
        {
        ...
        function calc_gross()
        {
            ...
            var summm=(Number(gross1) + Number(total1)+ Number(ctchead));
            // alert(summm);
            $('#ctc_mnth').val(Math.round(summm));    // CTC/month = Gross Salary + Employer Contribution Salary + CTC Head Amount 
            // $('#ctc_mnth').val(gross1+total1);    // CTC/month = Gross Salary + Employer Contribution Salary 
            var year = (Number(Math.round(summm)) * 12);
            var year1 = year.toFixed();
            $('#ctc_yr').val(Math.round(year1));
