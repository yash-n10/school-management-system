...
//                                                } ?>  required>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                        <select class="col-sm-8 chosen-select form-control" id="category" name="category" class="designation" disabled="true">
                                            <option value="">Select Category</option>                                                                    
                                            <option value="1" <?php if ($cat == '1') {
                                                echo 'selected=selected';
                                            } ?>>Teaching Staff</option>
                                            <option value="2" <?php if ($cat == '2') {
                                                echo 'selected=selected';
