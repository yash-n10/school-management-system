...
<div class="form-group has-feedback">
	<div class="box">
		<div class="box-body">
			<div class="col-lg-12">
                <div class="col-lg-6" >
                    <a class="btn btn-primary" href="<?php echo base_url('transport/Vehicles'); ?>">
						<i class="fa fa-reply fa-lg"></i>&nbsp; &nbsp;Back
					</a>
                </div>
				<div class="col-lg-6" style="text-align:right;">
					<a class="btn btn-success" href="<?php echo base_url('transport/Vehicles/download_format'); ?>" download="">
		...
		<div class="box-body">
			<form enctype='multipart/form-data' id='form' class="form-horizontal" action="<?php echo base_url('transport/Vehicles/upload'); ?>" method='post'>
				<div class="box-body">
					...
					<div class="col-lg-2"><input type='submit' class="btn btn-success" name='submit' id='submit' value='New Vehicles Upload'></div>
				...
				<!--<li>D.O.B. should in the format of "dd-mm-YYYY" or "dd/mm/YYYY" e.g( 02-10-2017).</li>-->
                        ...
                        <div class="table-responsive " style="padding-top:8px">
                         <table class="table table-striped table-bordered ">
                            ...
                            <tr class="warning">
                                <td>Enter Vechicles No.</td>
                                <td>Total no. of seats</td>
                                <td>usable seats</td>
                                <td>1). Ownership <br> 2). Contract <br> (choose one option)</td>
                                <th>Contact Person</th>
