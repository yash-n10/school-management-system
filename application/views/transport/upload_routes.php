...
<div class="form-group has-feedback">
	<div class="box">
		<div class="box-body">
			<div class="col-lg-12">
                <div class="col-lg-6" >
                    <a class="btn btn-primary" href="<?php echo base_url('transport/Routes'); ?>">
						<i class="fa fa-reply fa-lg"></i>&nbsp; &nbsp;Back
					</a>
                </div>
				<div class="col-lg-6" style="text-align:right;">
					<a class="btn btn-success" href="<?php echo base_url('transport/Routes/download_format'); ?>" download="">
		...
		<div class="box-body">
			<form enctype='multipart/form-data' id='form' class="form-horizontal" action="<?php echo base_url('transport/Routes/upload'); ?>" method='post'>
				<div class="box-body">
					...
					<div class="col-lg-2"><input type='submit' class="btn btn-success" name='submit' id='submit' value='New Routes Upload'></div>
		...
		<div class="box-body">
			...
			<ol>
				...
				<!--<li>D.O.B. should in the format of "dd-mm-YYYY" or "dd/mm/YYYY" e.g( 02-10-2017).</li>-->
                                <li><span style="color:red"> In Case of <b><u>Bulk Update</u></b> , Vcehicle No. and Only those column which you want to change Against this Book Code is REQUIRED. Let Other Column be blank.</span></li>
			</ol>
                        ...
                        <div class="table-responsive " style="padding-top:8px">
                         <table class="table table-striped table-bordered ">
                            ...
                            <tr class="success">
								...
								<th>Vechicles No.<span style="color:red">(REQUIRED in UPLOAD and BULK UPDATE)</span></th>
                                <th>Route<span style="color:red;font-size:11px">REQUIRED in UPLOAD and BULK UPDATE</span></th>
                                <th>Start Place</th>
                                <th>End Place</th>
                                
                            </tr>                   
                            <tr class="warning">
                                <td><?php $str='';$s=1;foreach($fetch_vehicle as $ac){$str.=$s.'.)  '.$ac->vehicle_no.' <html><br></html>'; $s++;} rtrim($str); echo $str;?> (choose one option)</td>
                                <td>Route Code </td>
                                <td><?php $str1='';$s1=1;foreach($fetch_locations as $ac){$str1.=$s1.'.)  '.$ac->location_description.' <html><br></html>'; $s1++;} rtrim($str1); echo $str1;?></td>
                                <td><?php $str2='';$s2=1;foreach($fetch_locations as $ac){$str2.=$s2.'.)  '.$ac->location_description.' <html><br></html>'; $s2++;} rtrim($str2); echo $str2;?></td>
                            </tr>
                        </table>   
                        </div>
		</div>	
