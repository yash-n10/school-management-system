...
<div class="form-group has-feedback">
	<div class="box">
		<div class="box-body">
			<div class="col-lg-12">
                <div class="col-lg-6" >
                    <a class="btn btn-primary" href="<?php echo base_url('transport/Pickup_points'); ?>">
						<i class="fa fa-reply fa-lg"></i>&nbsp; &nbsp;Back
					</a>
                </div>
				<div class="col-lg-6" style="text-align:right;">
					<a class="btn btn-success" href="<?php echo base_url('transport/Pickup_points/download_format'); ?>" download="">
		...
		<div class="box-body">
			<form enctype='multipart/form-data' id='form' class="form-horizontal" action="<?php echo base_url('transport/Pickup_points/upload'); ?>" method='post'>
				<div class="box-body">
					...
					<div class="col-lg-2"><input type='submit' class="btn btn-success" name='submit' id='submit' value='New Pickup Upload'></div>
				...
				<!--<li>D.O.B. should in the format of "dd-mm-YYYY" or "dd/mm/YYYY" e.g( 02-10-2017).</li>-->
                        ...
                        <div class="table-responsive " style="padding-top:8px">
                         <table class="table table-striped table-bordered ">
                            ...
                            <tr class="warning">
                                <td><?php $str='';$s=1;foreach($fetch_route as $ac){$str.=$s.'.)  '.$ac->route_code.' <html><br></html>'; $s++;} rtrim($str); echo $str;?> (choose one option)</td>
                                <td><?php $str1='';$s1=1;foreach($fetch_locations as $ac){$str1.=$s1.'.)  '.$ac->location_description.' <html><br></html>'; $s1++;} rtrim($str1); echo $str1;?></td>
								<td>Time in 12:30 format</td>
                            </tr>
                        </table>   
                        </div>
		</div>	
