...
<body style="width:100%;border-style: double;">
    <div class="div1" >
        ...
        <span> <span><center> <img style="padding-top:5px;padding-bottom: 5px;" src="<?php echo $_SERVER['DOCUMENT_ROOT'];?>/<?php echo $logo;?>"height="75px;"></center>
         ...
         <center><h1><b><?php echo $school_desc[0]->description; ?> </b></h1>
          <?php echo $school_desc[0]->vision; ?><br>
        ...
        <center><span><b><u><i style="font-family:italic;font-size:18px;">To Whom It May Concern</i></u></b></span></center><br><br><br>
        <span ><b><i>This is to Certify that &nbsp; <?php echo $data[0]->father_name?> &nbsp; & &nbsp; <?php echo $data[0]->mother_name?> &nbsp; have paid the Tuition Fee of their ward in our school as per details given below:-<i></b></span><br><br><br>
    ...
    <br><br>
          <table style="width: 100%;top: 10px;">
            <tr>
                ...
                <th style="text-align:center;width:25%;" rowspan="2"><strong>Ward Name</strong></th>
                ...
                <th style="text-align:center;width:20%;" rowspan="2"><strong>Total Tuition Fee Paid</strong></th>
            ...
            <tr>
              ...
              <td style="text-align:center;width:25%" class="tablecustomtd"><?php echo $data[0]->first_name?>&nbsp;<?php echo $data[0]->middle_name?>&nbsp;<?php echo $data[0]->last_name?></td>
              <td style="text-align:center;width:10%" class="tablecustomtd"><?php echo $data[0]->class_name?>&nbsp;<?php echo $data[0]->sec_name?></td>
              <td style="text-align:center;width:15%" class="tablecustomtd"><?php echo $fee_session?></td>
        ...
        <!-- ******************* -->
          ...
          <span><i>Tuition Fee Paid(In Words): <?php echo strtoupper($total_amt_words.' only');?></i></span><br><br><br>

          <?php if($this->session->userdata('school_id')!=37) { ?>
  
    <p><span ><?php echo date("d/m/Y"); ?><br>ISSUE DATE</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;DEALING CLERK</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; PRINCIPAL</p><br><br><br>
<?php } else { ?>
