        ...
        <thead style="background:#99ceff;">
          <tr>
             ...
             <!--  <th style="border-bottom:0px">Category</th>
              ...
              <th style="border-bottom:0px">D/O/A</th>
              <th style="border-bottom:0px">D/O/S</th>
              <th style="border-bottom:0px">Descriptions</th>
              <th style="border-bottom:0px">Homework</th>
            ...
            foreach($homework as $value){?>
              <tr>
                ...
                <td>
                   <!--  <?php if(substr($right_access, 1,1)=='R') {?>
                    <span>
                        <a class="btn " data-toggle="modal" data-target="#viewModal_<?php echo $value->id;?>"><i class="fa fa-eye"></i> View</a>
                    </span>
                    <?php }?> -->
                    <?php if(substr($right_access, 2,1)=='U') {?>
                    <span>
                        <a class="btn a-edit" onclick="edit(<?php echo $value->id;?>,'<?php echo $value->doa;?>',<?php echo $value->class_id;?>,<?php echo $value->section_id;?>,<?php echo $value->subject_id;?>,'<?php echo $value->attachment;?>','<?php echo $value->dos;?>')"><i class="fa fa-edit"></i> </a>
                    </span>
                    <?php }?>
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
               <div class="form-group">
                 ...
                 <div class="form-group">
                    <label for="pwd">Homework Date</label>
                 ...
                 <div class="form-group">
                  ...
                  <!--  <div class="form-group">
                    ...
                    <select class="form-control" id="category" name="categ" required>
...
// });
 ...
 $('#form_a').submit(function(e){
                    e.preventDefault(); 
                         $.ajax({
                             url:'<?php echo base_url();?>academics/homework/Add_homework/save',
                             type:"post",
                             data:new FormData(this),
                             processData:false,
                             contentType:false,
