      ...
      <div class="modal-content">
        ...
        <div class="modal-body">          
          ...
          <div class=" form-group">
            ...
            <div class="col-md-8" style='padding-bottom:1%'>
              <select name="subject_add" class="form-control" id="subj" required onchange="getval(this);">
              </select>
            </div>           
          </div> 
...
function getval(sel)
{
    ...
    // alert(subjectid);
    var day = $('#day').val();
    var sectionset = $('#sectionselect').find('option:selected').val();
    var class_set = $('#classselect').find('option:selected').val();

    $.ajax({
        url:'<?php echo base_url()?>academics/Substitute_teacher/GetTeacher',
        data:{subjectid:subjectid,sectionset:sectionset,class_set:class_set,day:day},
        type:'POST',
        success:function(data)
        {
