...
?>
             ...
             <div>
                 <p style='font-size: 16px'><left><b>Setting Plan</b> </left></p>
             <p style='text-align: left; font-size: 16px'><b>Exam Name :<?php echo $value->exam_name;?></b></p>
<!--            <table style="width: 100%;border :none">
              <tr style="border :none">
                  <th colspan="4" style="text-align: left;"><center><b>Setting Plan</b> </center></th>          
              </tr>
              <tr style="border :none">
                  <th colspan="4" style="text-align: left;"><center><h3><b>Exam Name :</b><?php // echo $value->exam_name;?> </h3></center></th>          
              </tr>
            </table>-->
          </div>
          <?php // } ?>
            ...
            <table style="width: 100%;border :none">
              <tr style="border :none">
                  ...
                  <th colspan="4" style="text-align: left;" class="tablecustomtd tableright">Room</th>          
              </tr>
          ...
          { ?>
              <tr>
                  ...
                  <td colspan="4" style="text-align: left;"><?php echo $data->from_roll ?>-<?php echo $data->to_roll;?></td>
                  <td colspan="4" style="text-align: left;"><?php echo$data->room_no;?></td>
              </tr>
                      <?php $i++; }?>
                  <!-- upper row -->
          <!-- ******************* -->
