            ...
            <!-- <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                <div class="panel panel-default" style="border-top:2px solid #3c8dbc;">
                    ...
                    <div class="panel-body">
                        <div class="row" style="padding-bottom:5%">
                            <div class="col-sm-12 col-lg-12 col-md-12 col-xs-12">
                                <span class="info-box-text" style="color: #3c8dbc;font-weight: bold;font-size: 15px; text-align: center">Total Fees </span>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-6 col-lg-6 col-md-6 col-xs-6">
                                <i class="fa fa-inr" aria-hidden="true" style="font-size: xx-large;height:48px"></i>
                              
                            </div>
                            <div class="col-sm-6 col-lg-6 col-md-6 col-xs-6" >

                                <h2 class="no-margin" style="font-size:35px;text-align: right">0</h2>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-sm-2">
                    <a class="quick-btn" href="<?php echo base_url('admission/student'); ?>">
                        <img src="<?php echo base_url(''); ?>assets/img/dashboard_icon/students.png" class="img_size"><br/>
                        <label class="shortclink_name" style="margin-left: 6px;">Students</label>                       
                    </a>
                </div>
                  <div class="col-sm-2">
                    <a class="quick-btn" href="<?php echo base_url('feepayment/class_fee'); ?>">
                        <img src="<?php echo base_url(''); ?>assets/img/dashboard_icon/class_fees.jpg" class="img_size"><br/>
                        <label class="shortclink_name" style="margin-left: 6px;"> Class Fee</label>                       
                    </a>
                </div>
                  <div class="col-sm-2">
                  <a class="quick-btn" href="<?php echo base_url('feepayment/collection/Offline_payment'); ?>">
                    <img src="<?php echo base_url(''); ?>assets/img/dashboard_icon/feess.jpg" class="img_size"><br/>
                    <label class="shortclink_name"> Fee Collect</label>
                </a>
                  </div>
                 <!--  <div class="col-sm-2">
                  <a class="quick-btn" href="<?php echo base_url('hr/holidays'); ?>">
                    <img src="<?php echo base_url(''); ?>assets/img/dashboard_icon/hr.png" class="img_size"><br/>
                    <label class="shortclink_name" style="margin-left: -14px;">Salary Structure</label>
                </a>
                  </div> -->
                  <div class="col-sm-2">
                    <a class="quick-btn" href="<?php echo base_url('feepayment/report/fee_summary'); ?>">
                        <img src="<?php echo base_url(''); ?>assets/img/dashboard_icon/reports.png" class="img_size"><br/>
                        <label class="shortclink_name"> Fee Report</label>
                    </a>
                  </div>
                   <div class="col-sm-2">
                    <a class="quick-btn" href="<?php echo base_url('certificate/certificate'); ?>">
                        <img src="<?php echo base_url(''); ?>assets/img/dashboard_icon/exams.png" class="img_size"><br/>
                        <label class="shortclink_name"> Certificate</label>
                    </a>
                </div>
                  <!-- <div class="col-sm-2">
                    <a class="quick-btn" href="<?php echo base_url('library/Lib_card'); ?>">
                        <img src="<?php echo base_url(''); ?>assets/img/dashboard_icon/library.png" class="img_size"><br/>
                        <label class="shortclink_name"> Library</label>
                    </a>
                </div>
                <div class="col-sm-2">
                    <a class="quick-btn" href="<?php echo base_url('communication/noticeboard'); ?>">
                        <img src="<?php echo base_url(''); ?>assets/img/dashboard_icon/communication.png" class="img_size"><br/>
                        <label class="shortclink_name" style="margin-left: -8px;"> Communication</label>
                    </a>
                </div>
                <div class="col-sm-2">
                    <a class="quick-btn" href="<?php echo base_url('inventory/manage_products'); ?>">
                        <img src="<?php echo base_url(''); ?>assets/img/dashboard_icon/inventory.png" class="img_size"><br/>
                        <label class="shortclink_name"> Inventory</label>
                    </a>
                </div>
               
                <div class="col-sm-2">
                    <a class="quick-btn" href="<?php echo base_url('settings/role_permission'); ?>">
                        <img src="<?php echo base_url(''); ?>assets/img/dashboard_icon/settings.png" class="img_size"><br/>
                        <label class="shortclink_name"> Settings</label>
                    </a>
                </div> -->
                </div>
              </div>
...
<a href="<?php echo base_url();?>/new/transaction">TRANSACTION UPDATE</a>
    </div>
   ...
   <!--  <div class="row">
        ...
        <div class="col-lg-4 col-md-4">
            <div class="panel panel-default box box-solid">
                ...
                <ul class="nav nav-tabs">
                    <li class="active"><a data-toggle="tab" href="#classdefaultertabular" id="aclassdefaultabular">Tabular data</a></li>
                    <li ><a data-toggle="tab" href="#classdefaultergraph"  id="aclassdefaulgraph">Graphical data</a></li>
                ...
                foreach ($notices as $row):
                    ...
                    <li>
                        ...
                        <div class="timeline-item">
                            <span class="time"><i class="fa fa-clock-o"></i> <?= $rowdate ?></span>
