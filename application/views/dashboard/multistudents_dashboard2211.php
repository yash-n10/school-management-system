				...
				<div class="box-body" style="padding-left: 18px;">
					<?php if (in_array('store', $a)) { ?>
						<a class="btn btn-app bg-aqua" href="<?php echo base_url('store/payment'); ?>">
							<i class="fa fa-inr"></i>Store Payments
						</a>
					<?php } ?>
								...
								if(isset($student_pay) && count($student_pay) > 0) {
									...
									?>
										<tr>
											...
											<td style="cell-padding:none; text-align:center;"><a class="btn bg-aqua" href="<?php echo base_url('store/accsummary/stu_acc_details'); ?>">Passbook</a>
											</td>                                         
										</tr>
									<?php 
									}
