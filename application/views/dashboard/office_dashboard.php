                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        <div class="col-sm-6 col-lg-6 col-md-6 col-xs-6">
                            ...
                            <img src="<?php echo base_url(''); ?>assets/AdminLTE/dist/img/icon/total-stud.PNG" >
                        </div>
                        <div class="col-sm-6 col-lg-6 col-md-6 col-xs-6" >
             ...
             <div class="col-lg-6 col-md-6 col-sm-9 col-xs-12">
                <div class="panel panel-default" style="border-top:2px solid #3c8dbc;">
                    ...
                    <div class="panel-body">
                        <div class="row" style="padding-bottom:5%">
                            <div class="col-sm-12 col-lg-12 col-md-12 col-xs-12">
                                <a href="<?php echo base_url('admission/student'); ?>"><span class="info-box-text" style="color: #3c8dbc;font-weight: bold;font-size: 15px; text-align: center;">Pending Students </span></a>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-6 col-lg-6 col-md-6 col-xs-6">
    ...
    <br>
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card text-white bg-primary mb-3">
              <div class="card-header" style="padding: 0.75rem 1.25rem;margin-bottom: 0;background-color:#fff;border-bottom: 1px solid rgba(0, 0, 0, 0.125);color:#3c8dbc;;font-family:cursive;">Shortcut Links</div>
              <div class="card-body" style="-webkit-box-flex: 1;-ms-flex: 1 1 auto;flex: 1 1 auto;padding: 1.25rem;background-color:#eaeaea">

            <div class="row">
                <div class="col-sm-2">
                    <a class="quick-btn" href="<?php echo base_url('admission/student'); ?>">
                        <img src="<?php echo base_url(''); ?>assets/AdminLTE/dist/img/icon/student.png" style="width:75px;height:70px"><br/>
                        <label style="color:#005cb7;margin-left:13px">Students</label>                       
                    </a>
                </div>
                  <div class="col-sm-2">
                    <a class="quick-btn" href="<?php echo base_url('feepayment/class_fee'); ?>">
                        <img src="<?php echo base_url(''); ?>assets/AdminLTE/dist/img/icon/Fees_icon.png" style="width:65px;height:70px"><br/>
                        <label style="color:#005cb7;margin-left:5px"> Class Fee</label>                       
                    </a>
                </div>
                  <div class="col-sm-2">
                  <a class="quick-btn" href="<?php echo base_url('feepayment/collection/Offline_payment'); ?>">
                    <img src="<?php echo base_url(''); ?>assets/AdminLTE/dist/img/icon/fee-collectt.png" style="width:65px;height:70px"><br/>
                    <label style="    color: #005cb7;"> Fee Collect</label>
                </a>
                  </div>
                  <div class="col-sm-2">
                    <a class="quick-btn" href="<?php echo base_url('feepayment/report/fee_summary'); ?>">
                        <img src="<?php echo base_url(''); ?>assets/AdminLTE/dist/img/icon/fee-report.png" style="width:65px;height:70px"><br/>
                        <label style="color: #005cb7;"> Fee Report</label>
                    </a>
                  </div>
                  <div class="col-sm-2">
                    <a class="quick-btn" href="<?php echo base_url('certificate/certificate'); ?>">
                        <img src="<?php echo base_url(''); ?>assets/AdminLTE/dist/img/icon/certificate.png" style="width:85px;height:85px;margin-top:-10px"><br/>
                        <label style="color: #005cb7;margin-top:-8px;z-index: 100; position: absolute;  margin-top: -11px;margin-left: 16px;"> Certificate</label>
                    </a>
                </div>
                </div>
              </div>
