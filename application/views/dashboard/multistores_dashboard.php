...
<section class="content">    
			...
			<div class="box box-info">
				...
				<div class="box-body" style="padding-left: 18px;">
					<?php if (in_array('store', $a)) { ?>
						<a class="btn btn-app bg-green" href="<?php echo base_url('store/storeitem'); ?>">
							<i class="fa fa-table"></i> Store
						</a>
					<?php } ?>
	...
	<div class="row">
		<div class="col-md-8">          
			<div class="box box-info">
				<div class="box-header with-border" style="background-color: #ccffff;">
					<h5 class="box-title" style="color:#00c0ee; font-weight:bold;" >Rejected Bills</h5>
				</div>
				<div class="box-body">
					<div class="table-responsive">
						<table class="table table-bordered no-margin">
							...
							<tbody style="font-size:12px;">
								<?php 
								if(isset($store_bill_reject) && count($store_bill_reject) > 0) {
									foreach ($store_bill_reject as $arritem) { 
								?>
									<tr>
										<td><?php echo $arritem->id; ?></td> 
										<td><?php echo $arritem->bill_date; ?></td>                                         
										<td><?php echo $arritem->admission_no; ?></td>                                         
										<td><?php echo $arritem->student_fname . '  ' . $arritem->student_midname; ?></td>                                         
