        ...
        <div class="col-lg-3 col-md-6 col-sm-9 col-xs-12">
            <div class="panel panel-default" style="border-top:2px solid #3c8dbc;">
                ...
                <div class="panel-body">
                    ...
                    <div class="row" style="padding-bottom:5%">
                        <div class="col-sm-12 col-lg-12 col-md-12 col-xs-12">
                            <span class="info-box-text" style="color: #3c8dbc;font-weight: bold;font-size: 15px; text-align: center"><a href="<?php echo base_url()?>feepayment/report/receipt_cancel_report">Total Pending Receipt</a></span>
                        </div>

                    </div>
                    <div class="row"><a href="<?php echo base_url()?>feepayment/report/receipt_cancel_report">
                        <div class="col-sm-6 col-lg-6 col-md-6 col-xs-6">
                            <i class="fa fa-users" style="font-size: 50px;color: lightskyblue;"></i>
                        </div>
                        <div class="col-sm-6 col-lg-6 col-md-6 col-xs-6" >

                            <h2 class="no-margin" style="font-size:35px;text-align: right"><?php echo $total_pending_rep; ?></h2>
                        </div>
                    </a>
                    </div>
