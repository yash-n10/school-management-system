...
class Hostel extends CI_Controller {
    ...
    public $page_code = array('dormitory_type','dormitory_list','room_list','room_allocate_student','dormitory_report');
    public $page_id = array('','','','','');
    public $page_perm = array('----','----','----','----','----');
    
    public function __construct() {
        parent::__construct();

        $this->page_id = array($this->dbconnection->Get_namme("link_page", "l_code", "{$this->page_code[0]}", "id"),
                               $this->dbconnection->Get_namme("link_page", "l_code", "{$this->page_code[1]}", "id"),
                                $this->dbconnection->Get_namme("link_page", "l_code", "{$this->page_code[2]}", "id"),
                                $this->dbconnection->Get_namme("link_page", "l_code", "{$this->page_code[3]}", "id"),
                                $this->dbconnection->Get_namme("link_page", "l_code", "{$this->page_code[4]}", "id")
                            );
        ...
        $permission = $this->dbconnection->select("user_group_permission", "permission", "link_code={$this->page_id[0]} and user_group_id={$this->session->userdata('user_group_id')}");
        $this->page_perm[0] = !empty($permission) ? $permission[0]->permission : '----';
        $permission = $this->dbconnection->select("user_group_permission", "permission", "link_code={$this->page_id[1]} and user_group_id={$this->session->userdata('user_group_id')}");
        $this->page_perm[1] = !empty($permission) ? $permission[0]->permission : '----';
        $permission = $this->dbconnection->select("user_group_permission", "permission", "link_code={$this->page_id[2]} and user_group_id={$this->session->userdata('user_group_id')}");
        $this->page_perm[2] = !empty($permission) ? $permission[0]->permission : '----';
        $permission = $this->dbconnection->select("user_group_permission", "permission", "link_code={$this->page_id[3]} and user_group_id={$this->session->userdata('user_group_id')}");
        $this->page_perm[3] = !empty($permission) ? $permission[0]->permission : '----';
        $permission = $this->dbconnection->select("user_group_permission", "permission", "link_code={$this->page_id[4]} and user_group_id={$this->session->userdata('user_group_id')}");
        $this->page_perm[4] = !empty($permission) ? $permission[0]->permission : '----';
        $this->right_access = $this->page_perm;

        if (strpos($this->page_perm[0], '----') == true || strpos($this->page_perm[1], '----') == true || strpos($this->page_perm[2], '----') == true || strpos($this->page_perm[3], '----') == true ||strpos($this->page_perm[4], '----') == true) {
    ...
    public function dormitory_type($param1 = '', $param2 = '') {
        ...
        if ($param1 == 'save') {
            if (substr($this->right_access[0], 0, 1) != 'C') {
                redirect('404');
            }
            $data = array(
            ...
            if (substr($this->right_access[0], 2, 1) != 'U') {
                redirect('404');
            }
            $data = array(
                'dorm_type' => $this->input->post('dorm_typ'),
            ...
            if (substr($this->right_access[0], 3, 1) != 'D') {
    //            redirect(base_url(), 'refresh');
                redirect('404');
            }
            ...
            if (substr($this->right_access[0], 1, 1) != 'R') {
    //            redirect(base_url(), 'refresh');
                redirect('404');
            }
            $page_data = array(
    ...
    public function dormitory_list($param1 = '', $param2 = '') {
        if ($param1 == 'save') {
            ...
            if (substr($this->right_access[1], 0, 1) != 'C') {
    //            redirect(base_url(), 'refresh');
                redirect('404');
            }
            $data = array(
            ...
            if (substr($this->right_access[1], 2, 1) != 'U') {
    //            redirect(base_url(), 'refresh');
                redirect('404');
            }
            $data = array(
            ...
            if (substr($this->right_access[1], 3, 1) != 'D') {
    //            redirect(base_url(), 'refresh');
                redirect('404');
            }
            $class_id_string = $this->input->post('class_id_string');
            ...
            if (substr($this->right_access[1], 1, 1) != 'R') {
    //            redirect(base_url(), 'refresh');
                redirect('404');
            }
            $page_data = array(
    ...
    public function room_list($param1 = '', $param2 = '') {
        ...
        if ($param1 == 'save') 
        {
           ...
           /* if (substr($this->right_access[2], 0, 1) == 'C') {
                redirect('404');
            }*/
            $data = array(
        ...
        else if ($param1 == 'update') 
        {
            ...
            if (substr($this->right_access[2], 2, 1) != 'U') {
                redirect('404');
            }
            $data = array(
        ...
        else if ($param1 == 'delete') 
        {
            ...
            if (substr($this->right_access[2], 3, 1) != 'D') {
                redirect('404');
            }
            $class_id_string = $this->input->post('class_id_string');
            foreach ($class_id_string as $val) {
        ...
        if (substr($this->right_access[2], 1, 1) != 'R') {
            redirect('404');
        }
...
//               echo $cls_id;
        ...
        if ($param1 == 'save') {
            ...
            if (substr($this->right_access[3], 0, 1) == 'C') {
    //            redirect(base_url(), 'refresh');
                redirect('404');
            }
            $data = array(
        ...
        if ($param1 == 'update') {
            ...
            if (substr($this->right_access[3], 2, 1) != 'U') {
    //            redirect(base_url(), 'refresh');
                redirect('404');
            }
            $data = array(
        ...
        if ($param1 == 'delete') {
            ...
            if (substr($this->right_access[3], 3, 1) != 'D') {
    //            redirect(base_url(), 'refresh');
                redirect('404');
            }
        ...
        if (substr($this->right_access[3], 1, 1) != 'R') {
//            redirect(base_url(), 'refresh');
            redirect('404');
        }
        ...
        $page_data = array(
            ...
            'page_title' => 'Student Room Allocation',
            'section' => 'hostel',
            'customview' => '',
        );
...
//               print_r($fetch_stud);
    ...
    public function dormitory_report($param1 = '', $param2 = '') {
        ...
        if (substr($this->right_access[4], 1, 1) != 'R') {
//            redirect(base_url(), 'refresh');
            redirect('404');
        }
        $page_data = array(
