...
class Addfee extends CI_Controller {

	public $page_code = 'addfee';
	public $page_id = '';
	public $page_perm = '----';
	...
	public function __construct() {
		...
		$this->page_title = 'Add Fee';
		$this->section = 'store';
		$this->page_name = 'addfeelist_view';
		$this->customview = '';
	}
	...
	public function index() {
		...
		$this->data['right_access']	= $this->right_access;
             ...
             $this->data['arr_acc_book'] = $this->dbconnection->select_order('student_acc_book','*,'
					...
					. '1', 'remarks="Tution Fee" AND status="Y"', 'adm_no', 'ASC'); 
		$this->load->view('index', $this->data);   
	}


	public function add_bill() {
	//** This function is called from the ADD FEES button to rediect to another page  **
        
		if (substr($this->right_access, 0, 1) != 'C') {
			redirect('404');
		}

		$this->data['page_name'] 	= 'addfee_view'; 
		$this->data['id'] 			= $this->id;
		$this->data['page_title'] 	= 'Add Fees'; 
