...
<?php } else {
    ...
    if (count($query_half_trans) >= count($half_yearly_fee->result())) {
    ...
    ?> name="half[]"></td> 
                            ...
                            <td>
                            <?php if (count($query_half_trans) >= count($half_yearly_fee->result())) {
                                ?>
                                <input type="button" class="btn btn-success" style="padding:1px 7px;cursor:default" value="Paid">
    <?php } else { ?>
                                
                                <input type="button" class="btn btn-danger" value="Unpaid" style="padding:1px 7px;cursor:default">  
                            <?php } ?>
                            </td>
                            </tr> 
                            <tr>
                            <td><input type="checkbox" <?php
                        if (count($query_half_trans) >= count($half_yearly_fee->result()) * 2) {
                            echo 'checked disabled';
                        }
                        ?> name="half[]"></td> 
                            <td>Half yearly-2</td> 
                            ...
                            <td>
                            <?php if (count($query_half_trans) >= count($half_yearly_fee->result()) * 2) {
                                ?>
                                <input type="button" class="btn btn-success" style="padding:1px 7px;cursor:default" value="Paid">
    <?php } else { ?>
        ...
        if (date('Y-m-d') <= $academic_session[0]->end_date) {
            if ($academic_session[0]->fin_year == $student[0]->student_academicyear_id) {
                if ($disable_trans == 1) {
                    ...
                    if ($school[0]->stop_transaction == 'NO') {
                        ?>    
                                                <button class="btn btn-app" id="total_half" name="total_half2" type="button" style="padding:0px;float:right">
                                                <img src="<?php echo base_url('assets/img/pay_logo2.jpg'); ?>"><br>
