...
//            redirect(base_url(), 'refresh');
        ...
        $this->data['esic']         = '';
        $this->data['ifsc']         = '';
        $this->data['fetch_salary_name'] = $this->dbconnection->select('salary_type', "*", "status=1 and id NOT IN(19,20,21)");
        $this->data['payable']      = '';
        $this->data['gross_pay']    = '';
        $this->data['pf_empl']      = '';
...
//        print_r($emp_salary);
        ...
        $this->data['gross_pay']        = $gross_salary-67-15-94;
...
//            $data['validation'] = '';
            ...
            $salary=$this->dbconnection->select('salary_type', "*,(select amount from salary_entitlement where salary_id=salary_type.id and salary_id!=11 and salary_id!=13 and salary_group_id={$salary_group_id}) as sal_amt ", "status=1");
            // echo '<pre>';
            // print_r($salary);
            // die();
