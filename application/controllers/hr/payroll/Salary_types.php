...
class Salary_types extends MY_ListController
{
	...
	public function __construct()
	{
		...
		$this->display_columns = array('id' => 'ID', 'salary_code' => 'Salary Code', 'salary_name' => 'Salary Name', 'salary_typ_disp' => 'Earning/Deduction'
				);
		$this->edit_columns = array(
				'salary_code' => array('disp' => 'Salary Code', 'type' => 'text', 'required' => TRUE, 'maxlength' => 10),
				'salary_name' => array('disp' => 'Salary Name', 'type' => 'text', 'required' => TRUE, 'maxlength' => 20),
				'salary_typ' => array('disp' => 'Earning/Deduction', 'type' => 'select','required' => TRUE, 'select_opts' => array(
							...
							(object) array('opt_id' => '2', 'opt_disp' => 'Deduction'),
							),
						),
				);
		...
		$this->data_select = 'id, salary_code, salary_name, salary_typ, (CASE salary_typ WHEN 1 THEN "Earning" WHEN 2 THEN "Deduction" END) AS salary_typ_disp';
