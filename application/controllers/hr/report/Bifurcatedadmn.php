...
class Bifurcatedadmn extends CI_Controller
{
	public $page_code = 'bifurcatedadmn';
    public $page_id = '';
    public $page_perm = '----';
    ...
    public function __construct() {
        ...
        $this->page_title = 'Bifurcated Admncharges';
        $this->section = 'hr/report';
        $this->page_name = 'bifurcatedadmn';
        $this->customview = '';
    }
	...
	public function pdf()
	{
		...
		$this->data['name']=$name;
		$this->data['rows']=$rows;
		$this->load->view('hr/report/bifurcatedadmn_pdf',$this->data);
