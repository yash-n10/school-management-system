...
class Admncharges extends CI_Controller
{
	  public $page_code = 'admncharges';
    public $page_id = '';
    public $page_perm = '----';
    ...
    public function __construct() {
        ...
        $this->page_title = 'Admncharges';
        $this->section = 'hr/report';
        $this->page_name = 'admncharges_month';
        $this->customview = '';
    }
	public function index()
	{

		// $query= $this->db->query('SELECT * FROM crmfeesclub_29.employee');
		// $query= $query->result();
	...
	public function pdf()
	{
		...
		$this->data['name']=$name;
		$this->data['rows']=$rows;
		$this->load->view('hr/report/admncharges_pdf',$this->data);
