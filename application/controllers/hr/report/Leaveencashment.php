...
class Leaveencashment extends CI_Controller
{
	 public $page_code = 'leaveencashment';
    public $page_id = '';
    public $page_perm = '----';
    ...
    public function __construct() {
        ...
        $this->page_title = 'Leave Encashment';
        $this->section = 'hr/report';
        $this->page_name = 'leave';
        $this->customview = '';
    }
    ...
    public function pdf()
    {
        ...
        $this->data['name']=$name;
        $this->data['rows']=$rows;
        $this->load->view('hr/report/leave_pdf',$this->data);
