...
//        $this->dynamic_load->add_js('footer', array('src' => asset_url('js','bootstrap.min.js'), 'type' => 'text/javascript'));
    ...
    function dashboard() {
	    if ($this->session->userdata('login_type') != 'principal') redirect(base_url(), 'refresh');
    ...
    function sms_template_view($param1 = '', $param2 = '') {
        ...
        if ($param1 == 'create') {
            ...
            redirect(base_url() . 'principal/sms_template_view', 'refresh');
        }
        if ($param1 == 'do_update') {
            $data['sms_template_content'] = $this->input->post('sms_template_content');
...
<div class="controls"><select id="rec_c_id" name="rec_c_id" class="uniform validate[required]"><option value="">----select class----</option><option value="all">ALL</option>';
		...
		if($rmthd == 1){
		 ...
		 // if($sus_sm !=''){
			 $this->session->set_flashdata('msg', 'SMS Send Success');
                redirect(base_url() . 'principal/mailsms/', 'refresh');  
		 // }
    ...
    function student($param1 = '', $param2 = '', $param3 = '') {
        ...
        if ($param1 == 'create') {
            ...
            redirect(base_url() . 'principal/student/' . $data['class_id'], 'refresh');
			}
        }
		if ($param2 == 'promote')
		{
		...
		//	   redirect(base_url() . 'principal/student/' . $param2, 'refresh');
		  redirect(base_url() . 'principal/student/' . $param1, 'refresh');
        }
        if ($param2 == 'do_update') {
...
$this->load->view('principal/resultofupload', $details);

//passparameters($details);


//redirect( base_url() . 'principal/student/'.$class.'' );
   ...
   // $htmlMessage = $this->parser->parse('messages/email', $data, true);
    ...
    function parent($param1 = '', $param2 = '', $param3 = '') {
        ...
        if ($param1 == 'create') {
            ...
            redirect(base_url() . 'principal/parent/' . $class_id, 'refresh');
        }
        if ($param1 == 'do_update') {
            $data['name'] = $this->input->post('name');
            $data['email'] = $this->input->post('email');
            ...
            redirect(base_url() . 'principal/parent/' . $param3, 'refresh');
        } else if ($param1 == 'edit') {
...
/*     * **MANAGE STAFF**** */
    ...
    function staff($param1 = '', $param2 = '', $param3 = '') {
        ...
        if ($param1 == 'create') {
           ...
           // $this->email_model->account_opening_email('staff', $data['email']); //SEND EMAIL ACCOUNT OPENING EMAIL
            redirect(base_url() . 'principal/staff/', 'refresh');
        }
        if ($param1 == 'do_update') {
            $data['name'] = $this->input->post('name');
			$data['employee_code'] = $this->input->post('employee_code');
    ...
    function frontdeskenquiry($param1 = '', $param2 = '', $param3 = '') {
        ...
        if ($param1 == 'create') {
            ...
            redirect(base_url() . 'principal/frontdeskenquiry/', 'refresh');
        }
        if ($param1 == 'do_update') {
            $data['name'] = $this->input->post('name');
    ...
    function subject($param1 = '', $param2 = '') {
        ...
        if ($param1 == 'create') {
            ...
            redirect(base_url() . 'principal/subject/', 'refresh');
        }
        if ($param1 == 'do_update') {
            $data['name'] = $this->input->post('name');
            $data['class_id'] = $this->input->post('class_id');
    ...
    function academicyear($param1 = '', $param2 = '') {
        ...
        if ($param1 == 'create') {
            ...
            redirect(base_url() . 'principal/academicyear/', 'refresh');
        }
        if ($param1 == 'do_update') {
            $data['session_name'] = $this->input->post('sessionname');           
    ...
    function classes($param1 = '', $param2 = '') {
        ...
        if ($param1 == 'create') {
            ...
            redirect(base_url() . 'principal/classes/', 'refresh');
        }
        if ($param1 == 'do_update') {
			//$data['standard_id'] = $this->input->post('standard_id');
            $data['name'] = $this->input->post('name');
    ...
    function exam($param1 = '', $param2 = '') {
        ...
        if ($param1 == 'create') {
            ...
            redirect(base_url() . 'principal/exam/', 'refresh');
        }
        if ($param1 == 'do_update') {
    ...
    function marks($exam_id = '', $class_id = '', $subject_id = '') {
        ...
        if ($this->input->post('operation') == 'selection') {
            ...
            if ($page_data['exam_id'] > 0 && $page_data['class_id'] > 0 && $page_data['subject_id'] > 0) {
             redirect(base_url() . 'principal/marks/' . $page_data['exam_id'] . '/' . $page_data['class_id'] . '/' . $page_data['subject_id'], 'refresh');
            } else {
                $this->session->set_flashdata('mark_message', 'Choose exam, class and subject');
                redirect(base_url() . 'principal/marks/', 'refresh');
            }
        }
        if ($this->input->post('operation') == 'update') {
            ...
            redirect(base_url() . 'principal/marks/' . $this->input->post('exam_id') . '/' . $this->input->post('class_id') . '/' . $this->input->post('subject_id'), 'refresh');
        }
    ...
    function marksview($exam_id = '', $class_id = '', $subject_id = '') {
        ...
        if ($this->input->post('operation') == 'selection') {
            ...
            if ($page_data['exam_id'] > 0 && $page_data['class_id'] > 0 && $page_data['subject_id'] > 0) {
             redirect(base_url() . 'principal/marksview/' . $page_data['exam_id'] . '/' . $page_data['class_id'] . '/' . $page_data['subject_id'], 'refresh');
            } else if($page_data['exam_id'] > 0 && $page_data['class_id'] > 0 ){
				 redirect(base_url() . 'principal/marksview/' . $page_data['exam_id'] . '/' . $page_data['class_id'] , 'refresh');
			}else {
                $this->session->set_flashdata('mark_message', 'Choose exam, class and subject');
                redirect(base_url() . 'principal/marksview/', 'refresh');
            }
        }
        if ($this->input->post('operation') == 'update') {
            //echo "<pre>";print_r($_POST);exit;
            foreach($_POST['mark_obtained'] as $key =>  $mark)
            {
             ...
             $this->session->set_flashdata('flash_message', get_phrase('marks_updated'));            
            redirect(base_url() . 'principal/marksview/' . $this->input->post('exam_id') . '/' . $this->input->post('class_id') . '/' . $this->input->post('subject_id'), 'refresh');
        }
        $page_data['exam_id'] = $exam_id;
        $page_data['class_id'] = $class_id;
        $page_data['subject_id'] = $subject_id;
    ...
    function grade($param1 = '', $param2 = '') {
        ...
        if ($param1 == 'create') {
            ...
            redirect(base_url() . 'principal/grade/', 'refresh');
        }
        if ($param1 == 'do_update') {
            $data['name'] = $this->input->post('name');
            $data['grade_point'] = $this->input->post('grade_point');
    ...
    function class_routine($param1 = '', $param2 = '', $param3 = '') {
        ...
        if ($param1 == 'create') {
            ...
            redirect(base_url() . 'principal/class_routine/', 'refresh');
        }
        if ($param1 == 'do_update') {
            $data['class_id'] = $this->input->post('class_id');
            $data['subject_id'] = $this->input->post('subject_id');
    ...
    function invoice($param1 = '', $param2 = '', $param3 = '') {
        ...
        if ($param1 == 'create') {
            ...
            redirect(base_url() . 'principal/invoice', 'refresh');
        }
        if ($param1 == 'do_update') {
            $data['student_id'] = $this->input->post('student_id');
            $data['title'] = $this->input->post('title');
    ...
    function book($param1 = '', $param2 = '', $param3 = '') {
        ...
        if ($param1 == 'create') {
            ...
            redirect(base_url() . 'principal/book', 'refresh');
        }
        if ($param1 == 'do_update') {
            $data['name'] = $this->input->post('name');
            $data['description'] = $this->input->post('description');
    ...
    function book_cat($param1 = '', $param2 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            redirect(base_url() . 'principal/book_cat/', 'refresh');
        }
		if ($param1 == 'do_update') {
            $data['books_category_name']       = $this->input->post('catname');
            //$data['class_id']   = $this->input->post('class_id');
    ...
    function transport($param1 = '', $param2 = '', $param3 = '') {
        ...
        if ($param1 == 'create') {
            ...
            redirect(base_url() . 'principal/transport', 'refresh');
        }
        if ($param1 == 'do_update') {
            $data['route_name'] = $this->input->post('route_name');
            $data['number_of_vehicle'] = $this->input->post('number_of_vehicle');
    ...
    function dormitory($param1 = '', $param2 = '', $param3 = '') {
        ...
        if ($param1 == 'create') {
            ...
            redirect(base_url() . 'principal/dormitory', 'refresh');
        }
    ...
    function noticeboard($param1 = '', $param2 = '', $param3 = '') {
        ...
        if ($param1 == 'create') {
            ...
            redirect(base_url() . 'principal/noticeboard/', 'refresh');
        }
        if ($param1 == 'do_update') {
            $data['notice_title'] = $this->input->post('notice_title');
            $data['notice'] = $this->input->post('notice');
    ...
    function classnoticeboard($param1 = '', $param2 = '', $param3 = '') {
        ...
        if ($param1 == 'create') {
            ...
            redirect(base_url() . 'principal/classnoticeboard/', 'refresh');
        }
        if ($param1 == 'do_update') {
            $data['notice_title'] = $this->input->post('notice_title');
            $data['notice'] = $this->input->post('notice');
    ...
    function system_settings($param1 = '', $param2 = '', $param3 = '') {
        ...
        if ($param2 == 'do_update') {
            ...
            redirect(base_url() . 'principal/system_settings/', 'refresh');
        }
    ...
    function manage_language($param1 = '', $param2 = '', $param3 = '') {
        ...
        if ($param1 == 'update_phrase') {
            ...
            redirect(base_url() . 'principal/manage_language/edit_phrase/' . $language, 'refresh');
        }
        if ($param1 == 'do_update') {
            ...
            $this->session->set_flashdata('flash_message', get_phrase('settings_updated'));
            redirect(base_url() . 'principal/manage_language/', 'refresh');
        }
    ...
    function backup_restore($operation = '', $type = '') {
        ...
        if ($operation == 'restore') {
            ...
            redirect(base_url() . 'principal/backup_restore/', 'refresh');
        }
        if ($operation == 'delete') {
    ...
    function excel_import_data($file_name, $file_type, $class_id) {
        ...
        redirect(base_url() . 'principal/student/' . $class_id . '/upload', 'refresh');
    }
    ...
    function attendence($class_id = '', $month = '') {
        ...
        if ($this->input->post('operation') == 'selection') {
            ...
            if ($page_data['class_id'] > 0 && $page_data['month'] > 0) {
                redirect(base_url() . 'principal/attendence/' . $page_data['class_id'] . '/' . $page_data['month'], 'refresh');
            } else {
                $this->session->set_flashdata('attendence_message', 'Choose class');
                redirect(base_url() . 'principal/attendence/', 'refresh');
            }
        }
        ...
        if ($this->input->post('operation') == 'update') {
            ...
            redirect(base_url() . 'principal/attendence/' . $this->input->post('class_id') . '/' . $this->input->post('month'), 'refresh');
        }
    ...
    function fees_cat($param1 = '', $param2 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            redirect(base_url() . 'principal/fees_cat/', 'refresh');
        }
        if ($param1 == 'do_update') {
            $data['fees_category_name']       = $this->input->post('feescatname');
			 $data['fees_category_prefix']       = $this->input->post('feescatprefix');
    ...
    function class_wise_fees($param1 = '', $param2 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            //redirect(base_url() . 'principal/class_wise_fees/', 'refresh');
        }
        if ($param1 == 'do_update') {
            $data['class']       = $this->input->post('classname');
			 $data['fee_category']       = $this->input->post('fee_category_name');
	...
	function daily_attendence_view(){
		...
		if(isset($operation) && $operation == 'selection'){
			...
			if ($class_id > 0 && $attendence_date != '') {
				...
				redirect(base_url() . 'principal/daily_attendence/'.$class_id.'/'.$msdate, 'refresh');
				
                
            } else {
                $this->session->set_flashdata('attendence_message', 'Choose class');
                redirect(base_url() . 'principal/daily_attendence/', 'refresh');
            }
...
// E-Books Customization
 ...
 function ebookscat($param1 = '', $param2 = ''){
        ...
        if ($param1 == 'create') {
            ...
            redirect(base_url() . 'principal/ebookscat/', 'refresh');
        }
		if ($param1 == 'do_update') {
            $data['ebooks_category_name']       = $this->input->post('ebook_catname');
     ...
     function ebooks($param1 = '', $param2 = '', $param3 = '') {
        ...
        if ($param1 == 'create') {
			...
			redirect(base_url() . 'principal/ebooks');
	    }
        if ($param1 == 'do_update') {
            ...
            redirect(base_url() . 'principal/ebooks', 'refresh');
        } else if ($param1 == 'edit') {
	...
	***************************************************************************/
	function previousquestionpapers($param1 = '', $param2 = '', $param3 = '') {
        ...
        if ($param1 == 'create') {
			...
			//exit;
			redirect(base_url() . 'principal/previousquestionpapers');
	    }
        if ($param1 == 'do_update') {
            $data['ebooks_name'] 		= $this->input->post('ebooks_name');
			$data['ebooks_category_id'] = $this->input->post('ebooks_category_id');
            ...
            redirect(base_url() . 'principal/previousquestionpapers', 'refresh');
        } else if ($param1 == 'edit') {
            $page_data['edit_data'] = $this->db->get_where('ebooks', array(
                        'ebooks_id' => $param2
                    ))->result_array();
	...
	***************************************************************************/
	function onlinetest($param1 = '', $param2 = '', $param3 = '') {
	    if ($this->session->userdata('login_type') != 'principal') redirect(base_url(), 'refresh');
         if ($param1 == 'create') {
            ...
            //redirect(base_url() . 'principal/onlinetest/', 'refresh');
        }
        if ($param1 == 'do_update') {
            $data['ebooks_name'] = $this->input->post('ebooks_name');
			$data['ebooks_category_id'] = $this->input->post('ebooks_category_id');
	...
	function onlinetestedit() {
		...
		if(!empty($_POST)){
			...
			if($s){
					//redirect(base_url() . 'principal/ebooks', 'refresh');
					redirect(base_url() . 'principal/onlinetest');
				}
		}
    ...
    function employee_category($param1 = '', $param2 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            redirect(base_url() . 'principal/employee_category/', 'refresh');
        }
		if ($param1 == 'do_update') {
            $data['employee_category_name'] = $this->input->post('employee_category_name');
            $data['employee_category_status']   = $this->input->post('employee_category_status');
    ...
    function departments($param1 = '', $param2 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            redirect(base_url() . 'principal/departments/', 'refresh');
        }
		if ($param1 == 'do_update') {
            $data['department_name'] = $this->input->post('department_name');
            $data['department_status']   = $this->input->post('department_status');
	...
	function daily_staff_attendence_view(){
		...
		if(isset($operation) && $operation == 'selection'){
			...
			if ($class_id !=''  && $attendence_date != '') {
				...
				redirect(base_url() . 'principal/daily_staffattendence/'.$class_id.'/'.$msdate, 'refresh');
				
                
            } else {
                $this->session->set_flashdata('attendence_message', 'Choose class');
                redirect(base_url() . 'principal/daily_staffattendence/', 'refresh');
            }
    ...
    function staffattendence($department_id = '', $month = '') {
        ...
        if ($this->input->post('operation') == 'selection') {
            ...
            if ($page_data['department_id'] > 0 && $page_data['month'] > 0) {
                redirect(base_url() . 'principal/staffattendence/' . $page_data['department_id'] . '/' . $page_data['month'], 'refresh');
            } else {
                $this->session->set_flashdata('attendence_message', 'Choose class');
                redirect(base_url() . 'principal/staffattendence/', 'refresh');
            }
        }
        ...
        if ($this->input->post('operation') == 'update') {
            ...
            redirect(base_url() . 'principal/staffattendence/' . $this->input->post('department_id') . '/' . $this->input->post('month'), 'refresh');
        }
    ...
    function timetable_category($param1 = '', $param2 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            redirect(base_url() . 'principal/timetable_category/2', 'refresh');
        }
		if ($param1 == 'do_update') {
            $data['timetable_category_name'] = $this->input->post('timetable_category_name');
            $data['timetable_category_status']   = $this->input->post('timetable_category_status');
    ...
    function timetable($param1 = '', $param2 = '')
    {
		...
		if ($param1 == 'create') {
            ...
            redirect(base_url() . 'principal/timetable_category/1', 'refresh');
        }
		if ($param1 == 'do_update') {
            $data['timetable_cid'] = $this->input->post('timetable_cid');
            $data['timetable_title'] = $this->input->post('timetable_title');
    ...
    function standards($param1 = '', $param2 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            redirect(base_url() . 'principal/standards/', 'refresh');
        }
		if ($param1 == 'do_update') {
            $data['standard_name'] = $this->input->post('standard_name');
            $data['standard_status']   = $this->input->post('standard_status');
	...
	function ltypeinsert(){
		...
		if($ltypedata['leave_type_title'] !=''){
			...
			if($res){
				...
				redirect(base_url().'principal/leavetypes','refresh');
			}
	...
	function placementinsert(){
		...
		if($placementdata['placement_title'] !=''){
			...
			if($res){
				...
				redirect(base_url().'principal/placements','refresh');
			}
	...
	function fee_cat_insert(){
		...
		if($fcdata['fee_category'] !=''){
			...
			if($res){
				...
				redirect(base_url().'principal/feecategories','refresh');
			}
	...
	function fee_particular_update(){
		...
		if($fpdata['fee_particular_name'] !=''){
			...
			if($res){
				...
				redirect(base_url().'principal/feeparticulars/'.$fpdata['fee_category_id'] ,'refresh');
			}
	...
	function fee_period_insert(){
		...
		if($fcpdata['fee_period_cid'] !=''){
			...
			if($res){
				...
				redirect(base_url().'principal/feeperiods','refresh');
			}
