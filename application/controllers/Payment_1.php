...
class Payment_1 extends CI_Controller {
	...
	function paypal()
	{
		...
		$this->paypal->add_field('return',  		base_url().'payment/paypal_response/success');
		$this->paypal->add_field('cancel_return',  	base_url().'payment/paypal_response/cancel');
		$this->paypal->add_field('notify_url',  	base_url().'payment/paypal_ipn');
