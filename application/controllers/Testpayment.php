...
class Testpayment extends CI_Controller {
 ...
 //      $this->db->db_debug=TRUE;
       ...
       <?php }
        ...
        $this->section = 'feepayment/gateway2';
        $this->page_name = 'pay';
        $this->customview = '';
...
//        $this->token_hash = $this->security->get_csrf_hash();
    ...
    public function index() {
        if($this->school[0]->school_group=='ARMY') {
            ...
            redirect(base_url('payment_army2'));
            die();
        }
            ...
            if(!empty($this->academic_log_query))
        {
            ...
            {?>
                ...
                alert("Please Clear the dues of Session 2019-2020");
                 window.location.assign("http://erp.feesclub.com/Payment_Previous2");
                </script>
                <?php
...
//                    }
    ...
    public function Worldline_payment_gateway($data) {
        $this->load->view('feepayment/gateway2/WL_Pay_page', $data);
    }

    public function hdfc_payment_gateway($data) {
        $this->load->view('feepayment/gateway2/hdfc_payment_page', $data);
    }

    public function hdfc_ccavenue_gateway($data) {
        $this->load->view('feepayment/gateway2/hdfc_ccavenue_payment_page', $data);
    }
...
//            print_r($_POST);
        ...
        if ($payment_gateway == 'WORLDLINE') {  // WORLDLINE ............
            include ($_SERVER['DOCUMENT_ROOT'] . '/assets/gateway2/AWLMEAPI.php');
            $obj = new AWLMEAPI();
...
//                         print_r($response_var);
            $success_page = 'feepayment/gateway2/WL_Success_page';
            ...
            include ($_SERVER['DOCUMENT_ROOT'] . '/assets/gateway2/Crypto.php');
...
//                    $school_id = $response['merchant_param1'];
            ...
            $success_page = 'feepayment/gateway2/hdfc_ccavenue_success_page';
...
//                    echo "<br>Security Error. Illegal access detected";
            ...
            $success_page = 'feepayment/gateway2/hdfc_success_page';
...
//                $str .= ' Re-Admission-Fine,';
        ...
        if ($this->uri->segment(3) == 'dwld_no')
            $this->load->view('feepayment/gateway2/receipt_popup', $data);
        else
