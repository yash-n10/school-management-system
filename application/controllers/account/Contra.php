...
//            redirect(base_url(), 'refresh');
        ...
        $this->data['page_name'] = 'contra';
        $this->data['page_title'] = 'Contra';
        ...
        $voucher = $this->db->query("SELECT count(bill_gen_no) as vno FROM voucher where voucher_type='Contra' and module_name ='Contra' group by bill_gen_no;")->result();
        $v_no = count($voucher) + 1;
        $date = date('ymd');
        $this->data['voucher_no'] = 'CTR/' . $date . '/' . $v_no;
