...
//            redirect(base_url(), 'refresh');
        ...
        $this->data['page_name'] = 'debit_note';
        $this->data['page_title'] = 'Debit Note';
        ...
        $voucher = $this->db->query("SELECT count(bill_gen_no) as vno FROM voucher where voucher_type='debit_note' and module_name ='debit_note' group by bill_gen_no;")->result();
