...
class Month_Cal {
	...
	var $next_prev_url	= 'index.php?admin/calendar/calendar';
...
$dat= $dt->format('F');
		...
		$this->temp['heading_title_cell'] = str_replace('{heading}', $dat."&nbsp;".$year, $this->temp['heading_title_cell']);
		...
		//$day_names = $this->get_day_names();
                $day_names=array('Sunday','Monday','Tuesday','Wednesday','Thrusday','Friday','Saturday');
